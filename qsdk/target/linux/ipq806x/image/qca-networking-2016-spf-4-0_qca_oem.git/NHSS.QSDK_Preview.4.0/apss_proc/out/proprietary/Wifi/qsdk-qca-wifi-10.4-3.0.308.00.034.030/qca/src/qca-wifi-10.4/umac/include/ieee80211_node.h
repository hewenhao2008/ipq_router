...
#define IEEE80211_NODE_IPV6_MAX 7
    ...
    u_int32_t atf_units;                /* atf_units (user configured airtime) for this node */
    ...
    u_int32_t ni_atfdata_logged;        /* data log(history) available */
    u_int32_t ni_atfindex;              /* index to the data log */
...
#endif
    u_int32_t   ni_bwnss_map;        /* Peer Bandwidth NSS mapping*/
#if ATH_SUPPORT_NAC
    u_int8_t    is_nac;
#endif
