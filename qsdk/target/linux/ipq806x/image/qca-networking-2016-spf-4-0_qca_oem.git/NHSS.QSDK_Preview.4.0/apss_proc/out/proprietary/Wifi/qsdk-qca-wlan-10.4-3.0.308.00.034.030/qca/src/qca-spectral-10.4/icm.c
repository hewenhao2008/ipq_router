                         ...
                         bool *isup)
{
    ...
    *isup = FALSE;
    ...
    strncpy(ifr.ifr_name, dev_ifname, sizeof(ifr.ifr_name));
                         ...
                         bool *isap)
{
    ...
    *isap = FALSE;
    ...
    strncpy(iwr.ifr_name, dev_ifname, sizeof(iwr.ifr_name));
...
static int icm_init_radio_iface(ICM_INFO_T* picm, char *radio_ifname)
{
	...
	if(picm->numdevs > 0) {
        ...
        strncpy(picm->radio_ifname, radio_ifname, IFNAMSIZ);
