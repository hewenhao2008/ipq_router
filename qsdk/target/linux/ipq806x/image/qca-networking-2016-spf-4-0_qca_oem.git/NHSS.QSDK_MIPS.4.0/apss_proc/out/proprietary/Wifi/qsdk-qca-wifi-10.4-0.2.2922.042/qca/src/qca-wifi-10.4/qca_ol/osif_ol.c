    ...
    switch (rate1 & 0xF) // preamble
        ...
        case 0: //CCK
            {
                switch(rate1_1) //l_sig_rate
                    {
                    case 0x1:  //long 1M
                        printk("CCK 1 Mbps long preamble\n");
                        break;
                    case 0x2: //long 2M
                        printk("CCK 2 Mbps long preamble\n");
                        break;
                    case 0x3: //long 5.5M
                        printk("CCK 5.5 Mbps long preamble\n");
                        break;
                    case 0x4: //long 11M
                        printk("CCK 11 Mbps long preamble\n");
                        break;
                    case 0x5: //short 2M
                        printk("CCK 2 Mbps short preamble\n");
                        break;
                    case 0x6: //short 5.5M
                        printk("CCK 5.5 Mbps short preamble\n");
                        break;
                    case 0x7: //short 11M
                        printk("CCK 11 Mbps short preamble\n");
                        break;
                    }
            }
            break;
        ...
        case 3:
            switch (rate1_1 & 0x3)
                {
                case 0x0: // VHT20
                    printk("VHT20 NSS%c MCS%c\n", '1' + ((rate1_1 >> 10) & 0x3),
                           '0' + ((rate2 >> 4) & 0xf));

                    break;

                case 0x1: // VHT40
                    printk("VHT40 NSS%c MCS%c\n", '1' + ((rate1_1 >> 10) & 0x3),
                           '0' + ((rate2 >> 4) & 0xf));

                    break;

                case 0x2: // VHT80
                    printk("VHT80 NSS%c MCS%c\n", '1' + ((rate1_1 >> 10) & 0x3),
                           '0' + ((rate2 >> 4) & 0xf));
