    ...
    const u8 *frm)
{
    ...
    if(actionargs->category ==  WLAN_ACTION_VENDOR_SPECIFIC) {
        ...
        mgmt->u.action.u.vs_public_action.action = 0x00;//WLAN_EID_VENDOR_SPECIFIC;
        mgmt->u.action.u.vs_public_action.oui[0] = 0x03;
        mgmt->u.action.u.vs_public_action.oui[1] = 0x7f;
        mgmt->u.action.u.vs_public_action.oui[2] = WLAN_EID_VENDOR_SPECIFIC;
        switch(actionargs->action) {
            case WPSIE_LISTEN_RE:
                ...
                pos += 1;
                memcpy(pos, (u8*) &mgmt->u.action.u.vs_public_action.action, 3);
                pos += 3;
