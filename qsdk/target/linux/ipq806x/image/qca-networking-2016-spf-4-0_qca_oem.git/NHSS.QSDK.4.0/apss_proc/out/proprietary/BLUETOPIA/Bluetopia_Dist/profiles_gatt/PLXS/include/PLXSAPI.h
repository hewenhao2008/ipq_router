...
typedef enum
 {
   rcvSuccess               = PLXS_RACP_RESPONSE_CODE_VALUE_SUCCESS,
   rcvOpCodeNotSupported    = PLXS_RACP_RESPONSE_CODE_VALUE_OPCODE_NOT_SUPPORTED,
   rcvInvalidOperator       = PLXS_RACP_RESPONSE_CODE_VALUE_INVALID_OPERATOR,
   rcvOperatorNotSupported  = PLXS_RACP_RESPONSE_CODE_VALUE_OPERATOR_NOT_SUPPORTED,
   rcvInvalidOperand        = PLXS_RACP_RESPONSE_CODE_VALUE_INVALID_OPERAND,
   rcvNoRecordFound         = PLXS_RACP_RESPONSE_CODE_VALUE_NO_RECORDS_FOUND,
   rcvAbortUnsuccessful     = PLXS_RACP_RESPONSE_CODE_VALUE_ABORT_UNSUCCESSFUL,
   rcvProcedureNotCompleted = PLXS_RACP_RESPONSE_CODE_VALUE_PROCEDURE_NOT_COMPLETED,
   rcvOperandNotSupported   = PLXS_RACP_RESPONSE_CODE_VALUE_OPERAND_NOT_SUPPORTED,
