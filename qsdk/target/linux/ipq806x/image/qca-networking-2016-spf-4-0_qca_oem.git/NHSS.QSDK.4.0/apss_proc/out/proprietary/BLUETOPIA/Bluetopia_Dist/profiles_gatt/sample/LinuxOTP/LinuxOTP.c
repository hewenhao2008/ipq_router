...
static int RegisterOTS(void)
{
   ...
   if(!Connections)
   {
      ...
      if(!OTSInstanceID)
      {
         ...
         InitializeData.Connection_Mode                 = cmAutomaticAccept;
...
static void GetConnectionMode(void)
{
   ...
   if(OTSInstanceID)
   {
      ...
      if((Result = OTS_Channel_Get_Connection_Mode(BluetoothStackID, OTSInstanceID, &Mode))== 0)
      {
         ...
         switch(Mode)
         {
            case cmAutomaticAccept:
               printf("cmAutomaticAccept.\r\n");
               break;
            case cmAutomaticReject:
               printf("cmAutomaticReject.\r\n");
               break;
            case cmManualAccept:
               printf("cmManualAccept.\r\n");
               break;
            default:
               printf("Invalid.\r\n");
               break;
...
static void SetConnectionMode(OTS_Channel_Connection_Mode_t Mode)
{
   ...
   if(OTSInstanceID)
   {
      ...
      if((Mode >= cmAutomaticAccept) && (Mode <= cmManualAccept))
      {
