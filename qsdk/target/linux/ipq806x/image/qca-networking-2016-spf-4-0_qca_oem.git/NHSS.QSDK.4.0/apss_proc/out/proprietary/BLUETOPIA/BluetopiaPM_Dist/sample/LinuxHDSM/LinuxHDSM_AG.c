      ...
      if(HDSventCallbackID)
      {
         ...
         if((TempParam) && (TempParam->NumberofParameters > 0))
         {
            ...
            if(!Result)
            {
               ...
               Result = HDSM_Connect_Remote_Device(HDSventCallbackID, sctAudioGateway, BD_ADDR, ServerPortNumber, ConnectionFlags, HDSM_Event_Callback, NULL, NULL);
   ...
   if(Initialized)
   {
      ...
      if(HDSventCallbackID)
      {
         ...
         if((TempParam) && (TempParam->NumberofParameters > 0))
         {
            ...
            Result = HDSM_Disconnect_Device(HDSventCallbackID, sctAudioGateway, BD_ADDR);
   ...
   if(Initialized)
   {
      ...
      if(HDSventCallbackID)
      {
         ...
         if((TempParam) && (TempParam->NumberofParameters > 1))
         {
            ...
            Result = HDSM_Connection_Request_Response(HDSventCallbackID, sctAudioGateway, BD_ADDR, (Boolean_t)(TempParam->Params[1].intParam));
   ...
   if(Initialized)
   {
      ...
      if((TempParam) && (TempParam->NumberofParameters >= 1))
      {
         ...
         if(!ret_val)
         {
            ...
            if(ServiceInformation.Flags & HDSM_SERVICE_INFORMATION_FLAGS_HEADSET_DATA_VALID)
            {
               printf("   Port:  %u\r\n", ServiceInformation.HeadsetInformation.PortNumber);
               printf("   Flags: %08lX\r\n", ServiceInformation.HeadsetInformation.Flags);
            }
            else
            {
               printf("   No Headset record present\r\n");
            }
         }
         else
   ...
   if(Initialized)
   {
      ...
      if(HDSventCallbackID)
      {
         ...
         if((TempParam) && (TempParam->NumberofParameters > 0) && (TempParam->Params[0].strParam))
         {
            ...
            /* submit the command.                                      */
            Result = HDSM_Query_SCO_Connection_Handle(HDSventCallbackID, sctAudioGateway, BD_ADDR, &SCOHandle);
