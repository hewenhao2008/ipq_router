   ...
   if((RequestData) && (ResponseData))
   {
      ...
      if(RequestData->Operator == rotAllRecords)
      {
         ...
         if(NumberOfRecordsToReport)
         {
            ...
            /* Success.                                                 */
            ResponseData->Operand.Response_Code = rcvSuccess;
         }
         else
         {
            /* No records found.                                        */
            ResponseData->Operand.Response_Code = rcvNoRecordFound;
         }
      }
      else
      {
         /* Operator not supported.                                     */
         ResponseData->Operand.Response_Code = rcvInvalidOperator;
      }
   }
}
...
static void DeleteStoredRecordsProcedure(PLXS_RACP_Request_Data_t *RequestData, PLXS_RACP_Response_Data_t *ResponseData)
{
   ...
   if((RequestData) && (ResponseData))
   {
      ...
      {
         /* Operator not supported.                                     */
         ResponseData->Operand.Response_Code = rcvOperatorNotSupported;
      }
   }
}
         ...
         case rrotResponseOpCode:
            ...
            switch(ResponseData->Operand.Response_Code)
            {
               ...
               case rcvOpCodeNotSupported:
                  ...
                  break;
               case rcvInvalidOperator:
                  printf("Invalid Operator.\r\n");
                  break;
               case rcvOperatorNotSupported:
                  printf("Operator Not Supported.\r\n");
                  break;
               case rcvInvalidOperand:
                  printf("Invalid Operand.\r\n");
                  break;
               case rcvNoRecordFound:
                  printf("No Records Found.\r\n");
                  break;
               case rcvAbortUnsuccessful:
                  printf("Abort Unsuccessful.\r\n");
                  break;
               case rcvProcedureNotCompleted:
                  printf("Procedure Not Completed.\r\n");
                  break;
               case rcvOperandNotSupported:
                     ...
                     if(DeviceInfo->PLXSServerInfo.Record_Access_Control_Point_CCCD == PLXS_CLIENT_CHARACTERISTIC_CONFIGURATION_INDICATE_ENABLE)
                     {
                        ...
                        switch(RACPRequestData.Op_Code)
                        {
                           ...
                           case rrtAbortOperationRequest:
                              ...
                              RACPResponseData.Operand.Response_Code = rcvSuccess;
                              break;
                           case rrtNumberOfStoredRecordsRequest:
                           ...
                           default:
                              ...
                              RACPResponseData.Response_Op_Code      = rrotResponseOpCode;
                              RACPResponseData.Operator              = rotNull;
                              RACPResponseData.Operand.Response_Code = rcvOpCodeNotSupported;
                              break;
                        }
                        ...
                        /* sent.                                        */
                        if((RACPResponseData.Request_Op_Code != (PLXS_RACP_Request_Type_t)rrtReportStoredRecordsRequest) || ((RACPResponseData.Request_Op_Code == (PLXS_RACP_Request_Type_t)rrtReportStoredRecordsRequest) && (RACPResponseData.Operand.Response_Code != (PLXS_RACP_Response_Code_Value_t)rcvSuccess)))
                        {
