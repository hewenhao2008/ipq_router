         ...
         if(Initialized)
         {
            ...
            switch(EventData->EventDataType)
            {
               case cetGetBodySensorLocationResponse:
                  ...
                  if(EventData->EventData.GetBodySensorLocationResponse.TransactionData->AddressID == MSG_GetServerAddressID())
               ...
               case cetResetEnergyExpendedResponse:
                  ...
                  if(EventData->EventData.ResetEnergyExpendedResponse.TransactionData->AddressID == MSG_GetServerAddressID())
...
static Device_Entry_t *DiscoverHeartRateSensor(BD_ADDR_t *BluetoothAddress)
{
   ...
   DebugPrint((BTPM_DEBUG_ZONE_LE_HEART_RATE | BTPM_DEBUG_LEVEL_FUNCTION), ("Exit 0x%X\n", DeviceEntry));
