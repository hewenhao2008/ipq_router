...
/*      All Rights Reserved.                                                  */
/*                                                                            */
/*  LINUXHIDM - Simple Linux application using Bluetopia Platform Manager     */
...
/*   --------  -----------    ------------------------------------------------*/
/*   02/18/11  D. Lange       Initial creation. (Based on LinuxAUDM)          */
/******************************************************************************/
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
...
#include "LinuxHIDM.h"     /* Main Application Prototypes and Constants.      */

#include "SS1BTHIDM.h"     /* HID Manager Application Programming Interface.  */
...
typedef struct _tagCommandTable_t
{
   ...
   /* The following structure is used to lookup strings for defined keys*/
   /* (to simply print them out on the display).                        */
typedef struct _tagHIDKeyLookupTableEntry_t
{
   Byte_t  Key;
   char   *String;
} HIDKeyLookupTableEntry_t;

   /* The following table are the Key mappings from the HID Key Index.  */
   /* This table is referenced from Key Index 0 (which is invalid).  The*/
   /* special keys (Shift, Control, etc) will be in a different table   */
   /* because they are sparsely populated at the end of the table.      */
   /* Rather than waste space for this, it will simply be in another    */
   /* table.                                                            */
   /* * NOTE * This table is only needed by this sample application to  */
   /*          display a human readable ASCII Key description to the    */
   /*          user.                                                    */
   /* * NOTE * This table is used by the RetrieveKeyDescription()       */
   /*          function to map a HID Key Index to human readable ASCII  */
   /*          description of the Key.                                  */
static const HIDKeyLookupTableEntry_t HIDKeyLookupTable[] =
{
   {  HID_HOST_KEYBOARD_A                            , "KEYBOARD_A"               },
   {  HID_HOST_KEYBOARD_B                            , "KEYBOARD_B"               },
   {  HID_HOST_KEYBOARD_C                            , "KEYBOARD_C"               },
   {  HID_HOST_KEYBOARD_D                            , "KEYBOARD_D"               },
   {  HID_HOST_KEYBOARD_E                            , "KEYBOARD_E"               },
   {  HID_HOST_KEYBOARD_F                            , "KEYBOARD_F"               },
   {  HID_HOST_KEYBOARD_G                            , "KEYBOARD_G"               },
   {  HID_HOST_KEYBOARD_H                            , "KEYBOARD_H"               },
   {  HID_HOST_KEYBOARD_I                            , "KEYBOARD_I"               },
   {  HID_HOST_KEYBOARD_J                            , "KEYBOARD_J"               },
   {  HID_HOST_KEYBOARD_K                            , "KEYBOARD_K"               },
   {  HID_HOST_KEYBOARD_L                            , "KEYBOARD_L"               },
   {  HID_HOST_KEYBOARD_M                            , "KEYBOARD_M"               },
   {  HID_HOST_KEYBOARD_N                            , "KEYBOARD_N"               },
   {  HID_HOST_KEYBOARD_O                            , "KEYBOARD_O"               },
   {  HID_HOST_KEYBOARD_P                            , "KEYBOARD_P"               },
   {  HID_HOST_KEYBOARD_Q                            , "KEYBOARD_Q"               },
   {  HID_HOST_KEYBOARD_R                            , "KEYBOARD_R"               },
   {  HID_HOST_KEYBOARD_S                            , "KEYBOARD_S"               },
   {  HID_HOST_KEYBOARD_T                            , "KEYBOARD_T"               },
   {  HID_HOST_KEYBOARD_U                            , "KEYBOARD_U"               },
   {  HID_HOST_KEYBOARD_V                            , "KEYBOARD_V"               },
   {  HID_HOST_KEYBOARD_W                            , "KEYBOARD_W"               },
   {  HID_HOST_KEYBOARD_X                            , "KEYBOARD_X"               },
   {  HID_HOST_KEYBOARD_Y                            , "KEYBOARD_Y"               },
   {  HID_HOST_KEYBOARD_Z                            , "KEYBOARD_Z"               },
   {  HID_HOST_KEYBOARD_1                            , "KEYBOARD_1"               },
   {  HID_HOST_KEYBOARD_2                            , "KEYBOARD_2"               },
   {  HID_HOST_KEYBOARD_3                            , "KEYBOARD_3"               },
   {  HID_HOST_KEYBOARD_4                            , "KEYBOARD_4"               },
   {  HID_HOST_KEYBOARD_5                            , "KEYBOARD_5"               },
   {  HID_HOST_KEYBOARD_6                            , "KEYBOARD_6"               },
   {  HID_HOST_KEYBOARD_7                            , "KEYBOARD_7"               },
   {  HID_HOST_KEYBOARD_8                            , "KEYBOARD_8"               },
   {  HID_HOST_KEYBOARD_9                            , "KEYBOARD_9"               },
   {  HID_HOST_KEYBOARD_0                            , "KEYBOARD_0"               },
   {  HID_HOST_KEYBOARD_RETURN                       , "KEYBOARD_RETURN"          },
   {  HID_HOST_KEYBOARD_ESCAPE                       , "KEYBOARD_ESCAPE"          },
   {  HID_HOST_KEYBOARD_DELETE                       , "KEYBOARD_DELETE"          },
   {  HID_HOST_KEYBOARD_TAB                          , "KEYBOARD_TAB"             },
   {  HID_HOST_KEYBOARD_SPACE_BAR                    , "KEYBOARD_SPACE_BAR"       },
   {  HID_HOST_KEYBOARD_MINUS                        , "KEYBOARD_MINUS"           },
   {  HID_HOST_KEYBOARD_EQUAL                        , "KEYBOARD_EQUAL"           },
   {  HID_HOST_KEYBOARD_LEFT_BRACKET                 , "KEYBOARD_LEFT_BRACKET"    },
   {  HID_HOST_KEYBOARD_RIGHT_BRACKET                , "KEYBOARD_RIGHT_BRACKET"   },
   {  HID_HOST_KEYBOARD_BACK_SLASH                   , "KEYBOARD_BACK_SLASH"      },
   {  HID_HOST_KEYBOARD_NON_US_POUND                 , "KEYBOARD_NON_US_POUND"    },
   {  HID_HOST_KEYBOARD_SEMICOLON                    , "KEYBOARD_SEMICOLON"       },
   {  HID_HOST_KEYBOARD_APOSTROPHE                   , "KEYBOARD_APOSTROPHE"      },
   {  HID_HOST_KEYBOARD_GRAVE_ACCENT                 , "KEYBOARD_GRAVE_ACCENT"    },
   {  HID_HOST_KEYBOARD_COMMA                        , "KEYBOARD_COMMA"           },
   {  HID_HOST_KEYBOARD_DOT                          , "KEYBOARD_DOT"             },
   {  HID_HOST_KEYBOARD_SLASH                        , "KEYBOARD_SLASH"           },
   {  HID_HOST_KEYBOARD_CAPS_LOCK                    , "KEYBOARD_CAPS_LOCK"       },
   {  HID_HOST_KEYBOARD_F1                           , "KEYBOARD_F1"              },
   {  HID_HOST_KEYBOARD_F2                           , "KEYBOARD_F2"              },
   {  HID_HOST_KEYBOARD_F3                           , "KEYBOARD_F3"              },
   {  HID_HOST_KEYBOARD_F4                           , "KEYBOARD_F4"              },
   {  HID_HOST_KEYBOARD_F5                           , "KEYBOARD_F5"              },
   {  HID_HOST_KEYBOARD_F6                           , "KEYBOARD_F6"              },
   {  HID_HOST_KEYBOARD_F7                           , "KEYBOARD_F7"              },
   {  HID_HOST_KEYBOARD_F8                           , "KEYBOARD_F8"              },
   {  HID_HOST_KEYBOARD_F9                           , "KEYBOARD_F9"              },
   {  HID_HOST_KEYBOARD_F10                          , "KEYBOARD_F10"             },
   {  HID_HOST_KEYBOARD_F11                          , "KEYBOARD_F11"             },
   {  HID_HOST_KEYBOARD_F12                          , "KEYBOARD_F12"             },
   {  HID_HOST_KEYBOARD_PRINT_SCREEN                 , "KEYBOARD_PRINT_SCREEN"    },
   {  HID_HOST_KEYBOARD_SCROLL_LOCK                  , "KEYBOARD_SCROLL_LOCK"     },
   {  HID_HOST_KEYBOARD_PAUSE                        , "KEYBOARD_PAUSE"           },
   {  HID_HOST_KEYBOARD_INSERT                       , "KEYBOARD_INSERT"          },
   {  HID_HOST_KEYBOARD_HOME                         , "KEYBOARD_HOME"            },
   {  HID_HOST_KEYBOARD_PAGE_UP                      , "KEYBOARD_PAGE_UP"         },
   {  HID_HOST_KEYBOARD_DELETE_FORWARD               , "KEYBOARD_DELETE_FORWARD"  },
   {  HID_HOST_KEYBOARD_END                          , "KEYBOARD_END"             },
   {  HID_HOST_KEYBOARD_PAGE_DOWN                    , "KEYBOARD_PAGE_DOWN"       },
   {  HID_HOST_KEYBOARD_RIGHT_ARROW                  , "KEYBOARD_RIGHT_ARROW"     },
   {  HID_HOST_KEYBOARD_LEFT_ARROW                   , "KEYBOARD_LEFT_ARROW"      },
   {  HID_HOST_KEYBOARD_DOWN_ARROW                   , "KEYBOARD_DOWN_ARROW"      },
   {  HID_HOST_KEYBOARD_UP_ARROW                     , "KEYBOARD_UP_ARROW"        },
   {  HID_HOST_KEYPAD_NUM_LOCK                       , "KEYPAD_NUM_LOCK"          },
   {  HID_HOST_KEYPAD_SLASH                          , "KEYPAD_SLASH"             },
   {  HID_HOST_KEYPAD_ASTERISK                       , "KEYPAD_ASTERISK"          },
   {  HID_HOST_KEYPAD_MINUS                          , "KEYPAD_MINUS"             },
   {  HID_HOST_KEYPAD_PLUS                           , "KEYPAD_PLUS"              },
   {  HID_HOST_KEYPAD_ENTER                          , "KEYPAD_ENTER"             },
   {  HID_HOST_KEYPAD_1                              , "KEYPAD_1"                 },
   {  HID_HOST_KEYPAD_2                              , "KEYPAD_2"                 },
   {  HID_HOST_KEYPAD_3                              , "KEYPAD_3"                 },
   {  HID_HOST_KEYPAD_4                              , "KEYPAD_4"                 },
   {  HID_HOST_KEYPAD_5                              , "KEYPAD_5"                 },
   {  HID_HOST_KEYPAD_6                              , "KEYPAD_6"                 },
   {  HID_HOST_KEYPAD_7                              , "KEYPAD_7"                 },
   {  HID_HOST_KEYPAD_8                              , "KEYPAD_8"                 },
   {  HID_HOST_KEYPAD_9                              , "KEYPAD_9"                 },
   {  HID_HOST_KEYPAD_0                              , "KEYPAD_0"                 },
   {  HID_HOST_KEYPAD_DOT                            , "KEYPAD_DOT"               },
   {  HID_HOST_KEYBOARD_NON_US_SLASH                 , "KEYBOARD_NON_US_SLASH"    },
   {  HID_HOST_KEYBOARD_APPLICATION                  , "KEYBOARD_APPLICATION"     }
} ;

   /* This is the sparsely populated Key table that was mentioned above.*/
   /* * NOTE * This table is only needed by this sample application to  */
   /*          display a human readable ASCII Key description to the    */
   /*          user.                                                    */
   /* * NOTE * This table is used by the RetrieveKeyDescription()       */
   /*          function to map a HID Key Index to human readable ASCII  */
   /*          description of the Key.                                  */
static const HIDKeyLookupTableEntry_t HIDSpecialKeyLookupTable[] =
{
   {  HID_HOST_KEYBOARD_LEFT_CONTROL                 , "KEYBOARD_LEFT_CONTROL"    },
   {  HID_HOST_KEYBOARD_LEFT_SHIFT                   , "KEYBOARD_LEFT_SHIFT"      },
   {  HID_HOST_KEYBOARD_LEFT_ALT                     , "KEYBOARD_LEFT_ALT"        },
   {  HID_HOST_KEYBOARD_LEFT_GUI                     , "KEYBOARD_LEFT_GUI"        },
   {  HID_HOST_KEYBOARD_RIGHT_CONTROL                , "KEYBOARD_RIGHT_CONTROL"   },
   {  HID_HOST_KEYBOARD_RIGHT_SHIFT                  , "KEYBOARD_RIGHT_SHIFT"     },
   {  HID_HOST_KEYBOARD_RIGHT_ALT                    , "KEYBOARD_RIGHT_ALT"       },
   {  HID_HOST_KEYBOARD_RIGHT_GUI                    , "KEYBOARD_RIGHT_GUI"       },
};
...
static unsigned int        HIDEventCallbackID;      /* Variable which holds the        */
                                                    /* current HID Event Callback ID   */
                                                    /* that is assigned from the HID   */
                                                    /* Manager when the local client   */
                                                    /* registers for HID Events.       */

static unsigned int        HIDDataCallbackID;       /* Variable which holds the        */
                                                    /* current HID Data Callback ID    */
                                                    /* that is assigned from the HID   */
                                                    /* Manager when the local client   */
                                                    /* registers for HID Data Events.  */
...
static int HIDConnectRequestResponse(ParameterList_t *TempParam);
static int HIDConnectDevice(ParameterList_t *TempParam);
static int HIDDisconnectDevice(ParameterList_t *TempParam);
static int HIDQueryConnected(ParameterList_t *TempParam);
static int HIDChangeIncomingFlags(ParameterList_t *TempParam);
static int HIDSetKeyboardRepeat(ParameterList_t *TempParam);
static int HIDSendReport(ParameterList_t *TempParam);
static int HIDSendGetReportRequest(ParameterList_t *TempParam);
static int HIDSendSetReportRequest(ParameterList_t *TempParam);
static int HIDSendGetProtocolRequest(ParameterList_t *TempParam);
static int HIDSendSetProtocolRequest(ParameterList_t *TempParam);
static int HIDSendGetIdleRequest(ParameterList_t *TempParam);
static int HIDSendSetIdleRequest(ParameterList_t *TempParam);
static int HIDRegisterEventCallback(ParameterList_t *TempParam);
static int HIDUnRegisterEventCallback(ParameterList_t *TempParam);
static int HIDRegisterDataCallback(ParameterList_t *TempParam);
static int HIDUnRegisterDataCallback(ParameterList_t *TempParam);
...
static char *RetrieveKeyDescription(Byte_t KeyIndex);
...
static void BTPSAPI HIDM_Event_Callback(HIDM_Event_Data_t *EventData, void *CallbackParameter);
...
static void UserInterface(void)
{
   ...
   AddCommand("HIDCONNECTREQUESTRESPONSE", HIDConnectRequestResponse);
   AddCommand("HIDCONNECTDEVICE", HIDConnectDevice);
   AddCommand("HIDDISCONNECTDEVICE", HIDDisconnectDevice);
   AddCommand("HIDQUERYCONNECTED", HIDQueryConnected);
   AddCommand("HIDCHANGEINCOMINGFLAGS", HIDChangeIncomingFlags);
   AddCommand("HIDSETKEYBOARDREPEAT", HIDSetKeyboardRepeat);
   AddCommand("HIDSENDREPORT", HIDSendReport);
   AddCommand("HIDSENDGETREPORTREQUEST", HIDSendGetReportRequest);
   AddCommand("HIDSENDSETREPORTREQUEST", HIDSendSetReportRequest);
   AddCommand("HIDSENDGETPROTOCOLREQUEST", HIDSendGetProtocolRequest);
   AddCommand("HIDSENDSETPROTOCOLREQUEST", HIDSendSetProtocolRequest);
   AddCommand("HIDSENDGETIDLEREQUEST", HIDSendGetIdleRequest);
   AddCommand("HIDSENDSETIDLEREQUEST", HIDSendSetIdleRequest);
   AddCommand("HIDREGISTEREVENTCALLBACK", HIDRegisterEventCallback);
   AddCommand("HIDUNREGISTEREVENTCALLBACK", HIDUnRegisterEventCallback);
   AddCommand("HIDREGISTERDATACALLBACK", HIDRegisterDataCallback);
   AddCommand("HIDUNREGISTERDATACALLBACK", HIDUnRegisterDataCallback);
...
static int DisplayHelp(ParameterList_t *TempParam)
{
   ...
   printf("*                  33)HIDConnectRequestResponse                  *\r\n");
   printf("*                  34)HIDConnectDevice                           *\r\n");
   printf("*                  35)HIDDisconnectDevice                        *\r\n");
   printf("*                  36)HIDQueryConnected                          *\r\n");
   printf("*                  37)HIDChangeIncomingFlags                     *\r\n");
   printf("*                  38)HIDSetKeyboardRepeat                       *\r\n");
   printf("*                  39)HIDSendReport                              *\r\n");
   printf("*                  40)HIDSendGetReportRequest                    *\r\n");
   printf("*                  41)HIDSendSetReportRequest                    *\r\n");
   printf("*                  42)HIDSendGetProtocolRequest                  *\r\n");
   printf("*                  43)HIDSendSetProtocolRequest                  *\r\n");
   printf("*                  44)HIDSendGetIdleRequest                      *\r\n");
   printf("*                  45)HIDSendSetIdleRequest                      *\r\n");
   printf("*                  46)HIDRegisterEventCallback                   *\r\n");
   printf("*                  47)HIDUnRegisterEventCallback                 *\r\n");
   printf("*                  48)HIDRegisterDataCallback                    *\r\n");
   printf("*                  49)HIDUnRegisterDataCallback                  *\r\n");
   printf("*                  Help, Quit.                                   *\r\n");
   printf("******************************************************************\r\n");
...
static int ChangeSimplePairingParameters(ParameterList_t *TempParam)
{
   ...
   /* The following function is responsible for Responding to a HID     */
...
static int HIDConnectRequestResponse(ParameterList_t *TempParam)
{
   ...
   if(Initialized)
   {
      ...
      if((TempParam) && (TempParam->NumberofParameters >= 2) && (TempParam->Params[0].strParam))
      {
         ...
         if(TempParam->NumberofParameters >= 3)
            Flags = (unsigned long)(TempParam->Params[2].intParam);
         else
            Flags = 0;

         Result = HIDM_Connection_Request_Response(RemoteDeviceAddress, (Boolean_t)(TempParam->Params[1].intParam), Flags);

         if(!Result)
         {
            printf("HIDM_Connection_Request_Response() Success: %d.\r\n", Result);
         ...
         else
         {
            ...
            printf("HIDM_Connection_Request_Response() Failure: %d, %s.\r\n", Result, ERR_ConvertErrorCodeToString(Result));
      ...
      {
         /* One or more of the necessary parameters is/are invalid.     */
         printf("Usage: HIDConnectRequestResponse [BD_ADDR] [Accept (0/1)] [Flags (1: Report, 2: Parse Boot)].\r\n");
   ...
   /* HID Device.  This function returns zero if successful and a       */
   /* negative value if an error occurred.                              */
static int HIDConnectDevice(ParameterList_t *TempParam)
{
   int           ret_val;
   ...
   if(Initialized)
   {
      ...
      if((TempParam) && (TempParam->NumberofParameters >= 1))
      {
         ...
         Result = HIDM_Connect_Remote_Device(RemoteDeviceAddress, Flags, HIDM_Event_Callback, 0, NULL);

         if(!Result)
         {
            printf("HIDM_Connect_Remote_Device() Success: %d.\r\n", Result);
         ...
         {
            /* Error in the API call. Inform the user and flag an error.*/
            printf("HIDM_Connect_Remote_Device() Failure: %d, %s.\r\n", Result, ERR_ConvertErrorCodeToString(Result));
      ...
      {
         /* One or more of the necessary parameters is/are invalid.     */
         printf("Usage: HIDConnectDevice [BD_ADDR] [Flags (0: None, 1: Auth, 2: Encrypt, 4: Report Mode, 8: Parse Boot)].\r\n");
   ...
   /* currently connected HID Device.  This function returns zero if    */
   /* successful and a negative value if an error occurred.             */
static int HIDDisconnectDevice(ParameterList_t *TempParam)
{
   int       ret_val;
   ...
   if(Initialized)
   {
      ...
      if((TempParam) && (TempParam->NumberofParameters >= 2))
      {
         ...
         Result = HIDM_Disconnect_Device(RemoteDeviceAddress, (Boolean_t)(TempParam->Params[1].intParam));

         if(!Result)
         {
            printf("HIDM_Disconnect_Remote_Device() Success: %d.\r\n", Result);
         ...
         {
            /* Error in the API call. Inform the user and flag an error.*/
            printf("HIDM_Disconnect_Remote_Device() Failure: %d, %s.\r\n", Result, ERR_ConvertErrorCodeToString(Result));
      ...
      {
         /* One or more of the necessary parameters is/are invalid.     */
         printf("Usage: HIDDisconnectDevice [BD_ADDR] [Disassociate (0/1)].\r\n");
...
static int HIDQueryConnected(ParameterList_t *TempParam)
{
   ...
   if(Initialized)
   {
      ...
      if((TempParam) && (TempParam->NumberofParameters))
      {
         ...
         if((!TempParam->Params[0].intParam) || ((TempParam->Params[0].intParam) && (BD_ADDRList)))
         {
            if((Result = HIDM_Query_Connected_Devices(TempParam->Params[0].intParam, BD_ADDRList, &TotalNumberDevices)) >= 0)
            {
               printf("HIDM_Query_Connected_Devices() Success: %d, Total Number Devices: %d.\r\n", Result, TotalNumberDevices);
            ...
            {
               /* Error attempting to query connected devices, inform   */
               /* the user and flag an error.                           */
               printf("HIDM_Query_Connected_Devices() Failure: %d, %s.\r\n", Result, ERR_ConvertErrorCodeToString(Result));
      ...
      {
         /* One or more of the necessary parameters is/are invalid.     */
         printf("Usage: HIDQueryConnected [Number of Devices].\r\n");
   ...
   /* HID Connection Flags.  This function returns zero if successful   */
   /* and a negative value if an error occurred.                        */
static int HIDChangeIncomingFlags(ParameterList_t *TempParam)
{
   int ret_val;
   ...
   if(Initialized)
   {
      ...
      if((TempParam) && (TempParam->NumberofParameters >= 1))
      {
         /* Parameters appear to be valid, map the specified parameters */
         /* into the API specific parameters.                           */
         Result = HIDM_Change_Incoming_Connection_Flags((unsigned long)(TempParam->Params[0].intParam));

         if(!Result)
         {
            printf("HIDM_Change_Incoming_Connection_Flags() Success: %d.\r\n", Result);
         ...
         {
            /* Error in the API call. Inform the user and flag an error.*/
            printf("HIDM_Change_Incoming_Connection_Flags() Failure: %d, %s.\r\n", Result, ERR_ConvertErrorCodeToString(Result));
      ...
      {
         /* One or more of the necessary parameters is/are invalid.     */
         printf("Usage: HIDChangeIncomingFlags [Flags (1: Authorization, 2: Authentication, 4: Encryption)].\r\n");
   ...
   /* The following function is responsible for setting the Keyboard    */
   /* Repeat Rate.  This function returns zero if successful and a      */
   /* negative value if an error occurred.                              */
static int HIDSetKeyboardRepeat(ParameterList_t *TempParam)
{
   int          ret_val;
   ...
   if(Initialized)
   {
      /* Make sure that all of the parameters required for this function*/
      /* appear to be at least semi-valid.                              */
      if((TempParam) && (TempParam->NumberofParameters >= 1) && ((!TempParam->Params[0].intParam) || ((TempParam->Params[0].intParam) && (TempParam->NumberofParameters >= 2))))
      {
         if(TempParam->NumberofParameters >= 2)
            RepeatRate = (unsigned int)(TempParam->Params[1].intParam);
         else
            RepeatRate = 0;

         /* Parameters appear to be valid, map the specified parameters */
         /* into the API specific parameters.                           */
         Result = HIDM_Set_Keyboard_Repeat_Rate((unsigned int)(TempParam->Params[0].intParam), RepeatRate);

         if(!Result)
         {
            printf("HIDM_Set_Keyboard_Repeat_Rate(%d, %d) Success: %d.\r\n", (unsigned int)(TempParam->Params[0].intParam), RepeatRate, Result);
         ...
         {
            /* Error in the API call. Inform the user and flag an error.*/
            printf("HIDM_Set_Keyboard_Repeat_Rate() Failure: %d, %s.\r\n", Result, ERR_ConvertErrorCodeToString(Result));
      ...
      {
         /* One or more of the necessary parameters is/are invalid.     */
         printf("Usage: HIDSetKeyboardRepeat [Repeat Delay] [Repeat Rate].\r\n");
   ...
   /* The following function is responsible for sending a HID Data      */
   /* Report.  This function returns zero if successful and a negative  */
   /* value if an error occurred.                                       */
static int HIDSendReport(ParameterList_t *TempParam)
{
   int          ret_val;
   int          Result;
   Byte_t       ReportData[132];
   BD_ADDR_t    RemoteDeviceAddress;
   unsigned int Index;
   unsigned int Temp;
   ...
   if(Initialized)
   {
      ...
      if(HIDDataCallbackID)
      {
         /* Make sure that all of the parameters required for this      */
         /* function appear to be at least semi-valid.                  */
         if((TempParam) && (TempParam->NumberofParameters >= 2) && (TempParam->Params[1].strParam))
         {
            /* Check to see if the report string appears to be          */
            /* semi-valid.                                              */
            if((!(strlen(TempParam->Params[1].strParam) & 0x01)) && ((strlen(TempParam->Params[1].strParam)/2) < sizeof(ReportData)))
            {
               /* Parameters appear to be valid, map the specified      */
               /* parameters into the API specific parameters.          */
               StrToBD_ADDR(TempParam->Params[0].strParam, &RemoteDeviceAddress);

               /* Now let's build the report string.                    */
               for(Index=0;Index<(strlen(TempParam->Params[1].strParam)/2);Index++)
               {
                  sscanf(&((TempParam->Params[1].strParam)[Index*2]), "%02X", &Temp);

                  ReportData[Index] = (Byte_t)Temp;
               }

               Result = HIDM_Send_Report_Data(HIDDataCallbackID, RemoteDeviceAddress, (Word_t)(strlen(TempParam->Params[1].strParam)/2), ReportData);

               if(!Result)
               {
                  printf("HIDM_Send_Report_Data() Success: %d.\r\n", Result);
               ...
               else
               {
                  ...
                  /* error.                                             */
                  printf("HIDM_Send_Report_Data() Failure: %d, %s.\r\n", Result, ERR_ConvertErrorCodeToString(Result));
            ...
            {
               /* Invalid Report data specified.                        */
               printf("Invalid Report Data: Report data must be ASCII Hex String (e.g. '110022').\r\n");
         ...
         {
            /* One or more of the necessary parameters is/are invalid.  */
            printf("Usage: HIDSendReport [BD_ADDR] [Report ASCII Hex String (e.g. '110022')].\r\n");
      ...
      else
      {
         ...
         printf("HID Manager Data Callback is not registered.\r\n");
   ...
   /* The following function is responsible for sending a GET_REPORT HID*/
...
static int HIDSendGetReportRequest(ParameterList_t *TempParam)
{
   ...
   if(Initialized)
   {
      ...
      if(HIDDataCallbackID)
      {
         /* Make sure that all of the parameters required for this      */
         /* function appear to be at least semi-valid.                  */
         if((TempParam) && (TempParam->NumberofParameters >= 3) && (TempParam->Params[1].intParam <= (int)hmrtFeature) && (TempParam->Params[2].intParam <= 255))
         {
            /* Parameters appear to be valid, map the specified         */
            /* parameters into the API specific parameters.             */
            StrToBD_ADDR(TempParam->Params[0].strParam, &RemoteDeviceAddress);

            Result = HIDM_Send_Get_Report_Request(HIDDataCallbackID, RemoteDeviceAddress, (HIDM_Report_Type_t)(TempParam->Params[1].intParam), (Byte_t)(TempParam->Params[2].intParam));

            if(!Result)
            {
               printf("HIDM_Send_Get_Report_Request() Success: %d.\r\n", Result);
            ...
            else
            {
               /* Error in the API call.  Inform the user and flag an   */
               /* error.                                                */
               printf("HIDM_Send_Get_Report_Request() Failure: %d, %s.\r\n", Result, ERR_ConvertErrorCodeToString(Result));
   ...
   {
      /* One or more of the necessary parameters is/are invalid.        */
      printf("Usage: HIDSendGetReportRequest [BD_ADDR] [Report Type (0:Input 1:Output 2:Feature)] [ReportID (0:None, 1-255:ID)].\r\n");
   }

   return(ret_val);
}

   /* The following function is responsible for sending a SET_REPORT HID*/
   /* request.  This function returns zero if successful and a negative */
   /* value if an error occurred.                                       */
static int HIDSendSetReportRequest(ParameterList_t *TempParam)
{
   ...
   if(Initialized)
   {
      ...
      if(HIDDataCallbackID)
      {
         /* Make sure that all of the parameters required for this      */
         /* function appear to be at least semi-valid.                  */
         if((TempParam) && (TempParam->NumberofParameters >= 3) && (TempParam->Params[1].intParam <= (int)hmrtFeature) && (TempParam->Params[2].strParam))
         {
            /* Check to see if the report string appears to be          */
            /* semi-valid.                                              */
            if((!(strlen(TempParam->Params[2].strParam) & 0x01)) && ((strlen(TempParam->Params[2].strParam)/2) < sizeof(ReportData)))
            {
               /* Parameters appear to be valid, map the specified      */
               /* parameters into the API specific parameters.          */
               StrToBD_ADDR(TempParam->Params[0].strParam, &RemoteDeviceAddress);
               ...
               /* Now let's build the report string.                    */
               for(Index=0;Index<(strlen(TempParam->Params[2].strParam)/2);Index++)
               {
                  sscanf(&((TempParam->Params[2].strParam)[Index*2]), "%2hhX", &Temp);

                  ReportData[Index] = (Byte_t)Temp;
               }

               Result = HIDM_Send_Set_Report_Request(HIDDataCallbackID, RemoteDeviceAddress, (HIDM_Report_Type_t)(TempParam->Params[1].intParam), (Word_t)(strlen(TempParam->Params[2].strParam)/2), ReportData);

               if(!Result)
               {
                  printf("HIDM_Send_Set_Report_Request() Success: %d.\r\n", Result);
               ...
               else
               {
                  /* Error in the API call.  Inform the user and flag an*/
                  /* error.                                             */
                  printf("HIDM_Send_Set_Report_Request() Failure: %d, %s.\r\n", Result, ERR_ConvertErrorCodeToString(Result));
   ...
   {
      /* One or more of the necessary parameters is/are invalid.        */
      printf("Usage: HIDSendSetReportRequest [BD_ADDR] [Report Type (0:Input 1:Output 2:Feature)] [Data].\r\n");
   }
   ...
   /* HID request.  This function returns zero if successful and a      */
   /* negative value if an error occurred.                              */
static int HIDSendGetProtocolRequest(ParameterList_t *TempParam)
{
   int       ret_val;
   ...
   if(Initialized)
   {
      ...
      if(HIDDataCallbackID)
      {
         ...
         if((TempParam) && (TempParam->NumberofParameters >= 1))
         {
            ...
            Result = HIDM_Send_Get_Protocol_Request(HIDDataCallbackID, RemoteDeviceAddress);

            if(!Result)
            {
               printf("HIDM_Send_Get_Protocol_Request() Success: %d.\r\n", Result);
            ...
            else
            {
               /* Error in the API call.  Inform the user and flag an   */
               /* error.                                                */
               printf("HIDM_Send_Get_Protocol_Request() Failure: %d, %s.\r\n", Result, ERR_ConvertErrorCodeToString(Result));
   ...
   {
      /* One or more of the necessary parameters is/are invalid.        */
      printf("Usage: HIDSendGetProtocolRequest [BD_ADDR].\r\n");
   }
...
static int HIDSendSetProtocolRequest(ParameterList_t *TempParam)
{
   ...
   if(Initialized)
   {
      ...
      if(HIDDataCallbackID)
      {
         /* Make sure that all of the parameters required for this      */
         /* function appear to be at least semi-valid.                  */
         if((TempParam) && (TempParam->NumberofParameters >= 2) && ((TempParam->Params[1].intParam == hmpBoot) || (TempParam->Params[1].intParam == hmpReport)))
         {
            /* Parameters appear to be valid, map the specified         */
            /* parameters into the API specific parameters.             */
            StrToBD_ADDR(TempParam->Params[0].strParam, &RemoteDeviceAddress);

            Result = HIDM_Send_Set_Protocol_Request(HIDDataCallbackID, RemoteDeviceAddress, (HIDM_Protocol_t)(TempParam->Params[1].intParam));

            if(!Result)
            {
               printf("HIDM_Send_Set_Protocol_Request() Success: %d.\r\n", Result);
            ...
            else
            {
               /* Error in the API call.  Inform the user and flag an   */
               /* error.                                                */
               printf("HIDM_Send_Set_Protocol_Request() Failure: %d, %s.\r\n", Result, ERR_ConvertErrorCodeToString(Result));
   ...
   {
      /* One or more of the necessary parameters is/are invalid.        */
      printf("Usage: HIDSendSetProtocolRequest [BD_ADDR] [Protocol (0:Boot 1:Report)].\r\n");
   }

   return(ret_val);
}

   /* The following function is responsible for sending a GET_IDLE HID  */
   /* request.  This function returns zero if successful and a negative */
   /* value if an error occurred.                                       */
static int HIDSendGetIdleRequest(ParameterList_t *TempParam)
{
   ...
   if(Initialized)
   {
      ...
      if(HIDDataCallbackID)
      {
         ...
         if((TempParam) && (TempParam->NumberofParameters >= 1))
         {
            ...
            Result = HIDM_Send_Get_Idle_Request(HIDDataCallbackID, RemoteDeviceAddress);

            if(!Result)
            {
               printf("HIDM_Send_Get_Idle_Request() Success: %d.\r\n", Result);
            ...
            else
            {
               /* Error in the API call.  Inform the user and flag an   */
               /* error.                                                */
               printf("HIDM_Send_Get_Idle_Request() Failure: %d, %s.\r\n", Result, ERR_ConvertErrorCodeToString(Result));
   ...
   {
      /* One or more of the necessary parameters is/are invalid.        */
      printf("Usage: HIDSendGetIdleRequest [BD_ADDR].\r\n");
   }

   return(ret_val);
}

   /* The following function is responsible for sending a SET_IDLE HID  */
   /* request.  This function returns zero if successful and a negative */
   /* value if an error occurred.                                       */
static int HIDSendSetIdleRequest(ParameterList_t *TempParam)
{
   ...
   if(Initialized)
   {
      ...
      if(HIDDataCallbackID)
      {
         /* Make sure that all of the parameters required for this      */
         /* function appear to be at least semi-valid.                  */
         if((TempParam) && (TempParam->NumberofParameters >= 2) && (TempParam->Params[1].intParam <= 255))
         {
            /* Parameters appear to be valid, map the specified         */
            /* parameters into the API specific parameters.             */
            StrToBD_ADDR(TempParam->Params[0].strParam, &RemoteDeviceAddress);

            Result = HIDM_Send_Set_Idle_Request(HIDDataCallbackID, RemoteDeviceAddress, (Byte_t)(TempParam->Params[1].intParam));

            if(!Result)
            {
               printf("HIDM_Send_Set_Idle_Request() Success: %d.\r\n", Result);
            ...
            else
            {
               /* Error in the API call.  Inform the user and flag an   */
               /* error.                                                */
               printf("HIDM_Send_Set_Idle_Request() Failure: %d, %s.\r\n", Result, ERR_ConvertErrorCodeToString(Result));
   ...
   {
      /* One or more of the necessary parameters is/are invalid.        */
      printf("Usage: HIDSendSetIdleRequest [BD_ADDR] [Idle (0-255; x*4ms)].\r\n");
   }

   return(ret_val);
}

   /* The following function is responsible for registering with the HID*/
   /* Manager to receive HID Events.  This function returns zero if     */
   /* successful and a negative value if an error occurred.             */
static int HIDRegisterEventCallback(ParameterList_t *TempParam)
{
   int Result;
   ...
   if(Initialized)
   {
      /* If there is an Event Callback Registered, then we need to flag */
      /* an error.                                                      */
      if(!HIDEventCallbackID)
      {
         /* Callback has not been registered, go ahead and attempt to   */
         /* register it.                                                */
         if((Result = HIDM_Register_Event_Callback(HIDM_Event_Callback, NULL)) > 0)
         {
            printf("HIDM_Register_Event_Callback() Success: %d.\r\n", Result);

            /* Note the Callback ID and flag success.                   */
            HIDEventCallbackID = (unsigned int)Result;
         ...
         else
         {
            /* Error registering the Callback, inform user and flag an  */
            /* error.                                                   */
            printf("HIDM_Register_Event_Callback() Failure: %d, %s.\r\n", Result, ERR_ConvertErrorCodeToString(Result));
      ...
      {
         /* Callback already registered, go ahead and notify the user.  */
         printf("HID Manager Event Callback already registered.\r\n");
   ...
   /* previously registered HID Event Registration with the HID Manager.*/
...
static int HIDUnRegisterEventCallback(ParameterList_t *TempParam)
{
   ...
   if(Initialized)
   {
      ...
      if(HIDEventCallbackID)
      {
         /* Callback has been registered, go ahead and attempt to       */
         /* un-register it.                                             */
         HIDM_Un_Register_Event_Callback(HIDEventCallbackID);

         printf("HIDM_Un_Register_Event_Callback() Success.\r\n");
      ...
      {
         /* Callback NOT registered, go ahead and notify the user.      */
         printf("HID Manager Event Callback is not registered.\r\n");
   ...
   /* The following function is responsible for registering with the HID*/
   /* Manager to receive HID Data Events (and to allow the local client */
   /* the ability to send HID Data Reports).  This function returns zero*/
   /* if successful and a negative value if an error occurred.          */
static int HIDRegisterDataCallback(ParameterList_t *TempParam)
{
   int Result;
   ...
   if(Initialized)
   {
      ...
      if(!HIDDataCallbackID)
      {
         /* Callback has not been registered, go ahead and attempt to   */
         /* register it.                                                */
         if((Result = HIDM_Register_Data_Event_Callback(HIDM_Event_Callback, NULL)) > 0)
         {
            printf("HIDM_Register_Data_Event_Callback() Success: %d.\r\n", Result);
         ...
         else
         {
            /* Error registering the Callback, inform user and flag an  */
            /* error.                                                   */
            printf("HIDM_Register_Data_Event_Callback() Failure: %d, %s.\r\n", Result, ERR_ConvertErrorCodeToString(Result));
      ...
      {
         /* Callback already registered, go ahead and notify the user.  */
         printf("HID Manager Data Callback already registered.\r\n");
   ...
   /* The following function is responsible for Un-registering a        */
   /* previously registered HID Data Event Registration with the HID    */
...
static int HIDUnRegisterDataCallback(ParameterList_t *TempParam)
{
   ...
   if(Initialized)
   {
      ...
      if(HIDDataCallbackID)
      {
         ...
         printf("HIDM_Un_Register_Data_Event_Callback() Success.\r\n");
...
static void DisplayDataElement(SDP_Data_Element_t *SDPDataElement, unsigned int Level)
{
   ...
   /* The following function is a utility function that exists to take  */
   /* the specified Key Index and map it to a human readable ASCII      */
   /* string description of the specified Key Index.  This function is  */
   /* guaranteed to return a pointer to a static string and will NEVER  */
   /* return NULL.                                                      */
static char *RetrieveKeyDescription(Byte_t KeyIndex)
{
   char *ret_val;

   /* Check to see what table to read from.                             */
   if((KeyIndex >= HIDKeyLookupTable[0].Key) && (((Byte_t)(KeyIndex - HIDKeyLookupTable[0].Key)) < (sizeof(HIDKeyLookupTable)/sizeof(HIDKeyLookupTableEntry_t))))
      ret_val = HIDKeyLookupTable[KeyIndex - HIDKeyLookupTable[0].Key].String;
   else
   {
      if((KeyIndex >= HIDSpecialKeyLookupTable[0].Key) && (((Byte_t)(KeyIndex - HIDSpecialKeyLookupTable[0].Key)) < (sizeof(HIDSpecialKeyLookupTable)/sizeof(HIDKeyLookupTableEntry_t))))
         ret_val = HIDSpecialKeyLookupTable[KeyIndex - HIDSpecialKeyLookupTable[0].Key].String;
      else
         ret_val = "INVALID/UKNOWN";
   }
   ...
   if(EventData)
   {
      ...
      switch(EventData->EventType)
      {
         case hetHIDDeviceConnectionRequest:
            printf("HIDM: Incoming Connection Request.\r\n");

            BD_ADDRToStr(EventData->EventData.DeviceConnectionRequestData.RemoteDeviceAddress, Buffer);

            printf("    Remote Address: %s\r\n", Buffer);

            printf("Respond with HIDConnectRequestResponse\r\n");
            break;
         case hetHIDDeviceConnected:
            printf("HIDM: Device Connected.\r\n");
         ...
         case hetHIDDeviceConnectionStatus:
            printf("HIDM: Device Connection Status: ");
            ...
            printf("%u, %s.\r\n", EventData->EventData.DeviceConnectionStatusEventData.ConnectionStatus, Message);

            BD_ADDRToStr(EventData->EventData.DeviceConnectionStatusEventData.RemoteDeviceAddress, Buffer);

            printf("    Remote Address: %s\r\n", Buffer);
            break;
         case hetHIDDeviceDisconnected:
            printf("HIDM: Device Disconnected.\r\n");

            BD_ADDRToStr(EventData->EventData.DeviceDisconnectedEventData.RemoteDeviceAddress, Buffer);

            printf("    Remote Address: %s\r\n", Buffer);
            break;
         case hetHIDBootKeyboardKeyPress:
            printf("HIDM: Boot Keyboard Key Press.\r\n");

            BD_ADDRToStr(EventData->EventData.BootKeyboardKeyPressEventData.RemoteDeviceAddress, Buffer);

            printf("    Data Callback : %d\r\n", EventData->EventData.BootKeyboardKeyPressEventData.HIDManagerDataCallbackID);
            printf("    Remote Address: %s\r\n", Buffer);
            printf("    Key Down      : %s\r\n", EventData->EventData.BootKeyboardKeyPressEventData.KeyDown?"TRUE":"FALSE");
            printf("    KeyModifiers  : 0x%02X\r\n", EventData->EventData.BootKeyboardKeyPressEventData.KeyModifiers);
            printf("    Key           : 0x%02X (%s)\r\n", EventData->EventData.BootKeyboardKeyPressEventData.Key, RetrieveKeyDescription(EventData->EventData.BootKeyboardKeyPressEventData.Key));
            break;
         case hetHIDBootKeyboardKeyRepeat:
            printf("HIDM: Boot Keyboard Key Repeat.\r\n");

            BD_ADDRToStr(EventData->EventData.BootKeyboardKeyRepeatEventData.RemoteDeviceAddress, Buffer);

            printf("    Data Callback : %d\r\n", EventData->EventData.BootKeyboardKeyRepeatEventData.HIDManagerDataCallbackID);
            printf("    Remote Address: %s\r\n", Buffer);
            printf("    KeyModifiers  : 0x%02X\r\n", EventData->EventData.BootKeyboardKeyRepeatEventData.KeyModifiers);
            printf("    Key           : 0x%02X (%s)\r\n", EventData->EventData.BootKeyboardKeyRepeatEventData.Key, RetrieveKeyDescription(EventData->EventData.BootKeyboardKeyRepeatEventData.Key));
            break;
         case hetHIDBootMouseEvent:
            printf("HIDM: Boot Mouse Mouse Event.\r\n");

            BD_ADDRToStr(EventData->EventData.BootMouseEventEventData.RemoteDeviceAddress, Buffer);

            printf("    Data Callback : %d\r\n", EventData->EventData.BootMouseEventEventData.HIDManagerDataCallbackID);
            printf("    Remote Address: %s\r\n", Buffer);
            printf("    CX            : %d\r\n", EventData->EventData.BootMouseEventEventData.CX);
            printf("    CY            : %d\r\n", EventData->EventData.BootMouseEventEventData.CY);
            printf("    ButtonState   : 0x%02X\r\n", EventData->EventData.BootMouseEventEventData.ButtonState);
            break;
         case hetHIDReportDataReceived:
            printf("HIDM: Report Data Received.\r\n");

            BD_ADDRToStr(EventData->EventData.ReportDataReceivedEventData.RemoteDeviceAddress, Buffer);

            printf("    Data Callback : %d\r\n", EventData->EventData.ReportDataReceivedEventData.HIDManagerDataCallbackID);
            printf("    Remote Address: %s\r\n", Buffer);
            ...
            break;
         case hetHIDGetReportResponse:
            printf("HIDM: GET_REPORT Response.\r\n");

            BD_ADDRToStr(EventData->EventData.GetReportResponseEventData.RemoteDeviceAddress, Buffer);

            printf("    Data Callback : %d\r\n", EventData->EventData.GetReportResponseEventData.HIDManagerDataCallbackID);
            printf("    Remote Address: %s\r\n", Buffer);

            switch(EventData->EventData.GetReportResponseEventData.ReportType)
            {
               case hmrtInput:
            ...
            printf("    Report Length : %u\r\n", EventData->EventData.GetReportResponseEventData.ReportLength);
            printf("    Report Data   : ");

            for(Index=0;Index<EventData->EventData.GetReportResponseEventData.ReportLength;Index++)
               printf("0x%02X ", EventData->EventData.GetReportResponseEventData.ReportData[Index]);
            printf("\r\n");

            break;
         case hetHIDSetReportResponse:
            printf("HIDM: SET_REPORT Response.\r\n");

            BD_ADDRToStr(EventData->EventData.SetReportResponseEventData.RemoteDeviceAddress, Buffer);

            printf("    Data Callback : %d\r\n", EventData->EventData.SetReportResponseEventData.HIDManagerDataCallbackID);
            printf("    Remote Address: %s\r\n", Buffer);

            switch(EventData->EventData.SetReportResponseEventData.Status)
            {
               case hmrSuccessful:
                  printf("    Result        : %s\r\n", "Successful");
                  break;
               case hmrNotReady:
                  printf("    Result        : %s\r\n", "Not Ready");
                  break;
               case hmrErrInvalidReportID:
                  printf("    Result        : %s\r\n", "Error Invalid Report ID");
                  break;
               case hmrErrUnsupportedRequest:
                  printf("    Result        : %s\r\n", "Error Unsupported Request");
                  break;
               case hmrErrInvalidParameter:
            ...
            break;
         case hetHIDGetProtocolResponse:
            printf("HIDM: GET_PROTOCOL Response.\r\n");

            BD_ADDRToStr(EventData->EventData.GetProtocolResponseEventData.RemoteDeviceAddress, Buffer);

            printf("    Data Callback : %d\r\n", EventData->EventData.GetProtocolResponseEventData.HIDManagerDataCallbackID);
            printf("    Remote Address: %s\r\n", Buffer);

            switch(EventData->EventData.GetProtocolResponseEventData.Status)
            {
               case hmrSuccessful:
                  printf("    Result        : %s\r\n", "Successful");
                  break;
            ...
            switch(EventData->EventData.GetProtocolResponseEventData.Protocol)
            {
               case hmpBoot:
                  printf("    Protocol      : %s\r\n", "Boot");
                  break;
            ...
            break;
         case hetHIDSetProtocolResponse:
            printf("HIDM: SET_PROTOCOL Response.\r\n");

            BD_ADDRToStr(EventData->EventData.SetProtocolResponseEventData.RemoteDeviceAddress, Buffer);

            printf("    Data Callback : %d\r\n", EventData->EventData.SetProtocolResponseEventData.HIDManagerDataCallbackID);
            printf("    Remote Address: %s\r\n", Buffer);

            switch(EventData->EventData.SetProtocolResponseEventData.Status)
            {
               case hmrSuccessful:
                  printf("    Result        : %s\r\n", "Successful");
                  break;
            ...
            break;
         case hetHIDGetIdleResponse:
            printf("HIDM: GET_IDLE Response.\r\n");

            BD_ADDRToStr(EventData->EventData.GetIdleResponseEventData.RemoteDeviceAddress, Buffer);

            printf("    Data Callback : %d\r\n", EventData->EventData.GetIdleResponseEventData.HIDManagerDataCallbackID);
            printf("    Remote Address: %s\r\n", Buffer);

            switch(EventData->EventData.GetIdleResponseEventData.Status)
            {
               case hmrSuccessful:
                  printf("    Result        : %s\r\n", "Successful");
                  break;
            ...
            printf("    Data Callback : %u\r\n", EventData->EventData.GetIdleResponseEventData.IdleRate);

            break;
         case hetHIDSetIdleResponse:
            printf("HIDM: SET_IDLE Response.\r\n");

            BD_ADDRToStr(EventData->EventData.SetIdleResponseEventData.RemoteDeviceAddress, Buffer);

            printf("    Data Callback : %d\r\n", EventData->EventData.SetIdleResponseEventData.HIDManagerDataCallbackID);
            printf("    Remote Address: %s\r\n", Buffer);

            switch(EventData->EventData.SetIdleResponseEventData.Status)
            {
               case hmrSuccessful:
                  printf("    Result        : %s\r\n", "Successful");
                  break;
            ...
            break;
         default:
            printf("HIDM: Unknown HID Manager Event Received: 0x%08X, Length: 0x%08X.\r\n", (unsigned int)EventData->EventType, EventData->EventLength);
            break;
      }
   }
   else
      printf("\r\nHIDM Event Data is NULL.\r\n");
