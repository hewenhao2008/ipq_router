...
typedef enum
{
   ctGlucoseMeasurement,
   ctGlucoseMeasurementContext,
...
typedef enum
{
   racReportStoredRecordsRequest   = GLS_RECORD_ACCESS_OPCODE_REPORT_STORED_RECORDS,
   racDeleteStoredRecordsRequest   = GLS_RECORD_ACCESS_OPCODE_DELETE_STORED_RECORDS,
   racAbortOperationRequest        = GLS_RECORD_ACCESS_OPCODE_ABORT_OPERATION,
   racNumberOfStoredRecordsRequest = GLS_RECORD_ACCESS_OPCODE_REPORT_NUM_STORED_RECORDS
...
typedef enum
{
   raoNull                 = GLS_RECORD_ACCESS_OPERATOR_NULL,
   raoAllRecords           = GLS_RECORD_ACCESS_OPERATOR_ALL_RECORDS,
   raoLessThanOrEqualTo    = GLS_RECORD_ACCESS_OPERATOR_LESS_THAN_OR_EQUAL_TO,
   raoGreaterThanOrEqualTo = GLS_RECORD_ACCESS_OPERATOR_GREATER_THAN_OR_EQUAL_TO,
   raoWithinRangeOf        = GLS_RECORD_ACCESS_OPERATOR_WITHIN_RANGE_OF,
   raoFirstRecord          = GLS_RECORD_ACCESS_OPERATOR_FIRST_RECORD,
   raoLastRecord           = GLS_RECORD_ACCESS_OPERATOR_LAST_RECORD
