...
static void BTPSAPI GATT_ClientEventCallback_HRP(unsigned int BluetoothStackID, GATT_Client_Event_Data_t *GATT_Client_Event_Data, unsigned long CallbackParameter)
{
   ...
   if((BluetoothStackID) && (GATT_Client_Event_Data) && ((TransactionEntry = DeleteTransactionEntry(GATT_Client_Event_Data->Event_Data.GATT_Request_Error_Data->ConnectionID, (Word_t)CallbackParameter)) != NULL))
   {
