...
#define BTPS_CONFIGURATION_TIMER_MAXIMUM_NUMBER_CONCURRENT_TIMERS           128
#define BTPS_CONFIGURATION_TIMER_TIMER_THREAD_STACK_SIZE                  65536
#define BTPS_CONFIGURATION_TIMER_MINIMUM_TIMER_RESOLUTION_MS                 50
   ...
   /*          received.                                                */
#define BTPS_CONFIGURATION_HCI_DRIVER_RECEIVE_PACKET_BUFFER_SIZE             (HCI_CALCULATE_ACL_DATA_SIZE(4096))
#define BTPS_CONFIGURATION_HCI_DRIVER_3WIRE_DEFAULT_SLIDING_WINDOW_SIZE          7
...
#define BTPS_CONFIGURATION_HCI_DRIVER_SIBS_DEFAULT_AGGRESSIVE_SLEEP              0
...
#define BTPS_CONFIGURATION_HCI_DISPATCH_THREAD_STACK_SIZE                196608
#define BTPS_CONFIGURATION_HCI_NUMBER_DISPATCH_MAILBOX_SLOTS               4096
...
#define BTPS_CONFIGURATION_HCI_NUMBER_OF_SCO_DATA_PACKETS                  0
   ...
   /* L2CAP Configuration.                                              */
#define BTPS_CONFIGURATION_L2CAP_MAXIMUM_SUPPORTED_STACK_MTU               (L2CAP_MAXIMUM_CONNECTION_MTU_SIZE)
...
#define BTPS_CONFIGURATION_RFCOMM_DEFAULT_MAXIMUM_NUMBER_QUEUED_DATA_PACKETS  0
...
#define BTPS_CONFIGURATION_SPP_DEFAULT_TRANSMIT_BUFFER_SIZE                8000
#define BTPS_CONFIGURATION_SPP_DEFAULT_RECEIVE_BUFFER_SIZE                 8000
#define BTPS_CONFIGURATION_SPP_DEFAULT_FRAME_SIZE                         ((2000 > SPP_FRAME_SIZE_MAXIMUM)?SPP_FRAME_SIZE_MAXIMUM:2000)
...
#define BTPS_CONFIGURATION_AVCTP_MAXIMUM_NUMBER_PROFILE_CONNECTIONS                  64
...
#define BTPS_CONFIGURATION_BTCOMM_DISPATCH_THREAD_STACK_SIZE             131072
#define BTPS_CONFIGURATION_BTCOMM_NUMBER_DISPATCH_MAILBOX_SLOTS             256
...
#define BTPS_CONFIGURATION_BTSER_DISPATCH_THREAD_STACK_SIZE              131072
#define BTPS_CONFIGURATION_BTSER_NUMBER_DISPATCH_MAILBOX_SLOTS              256
...
#define BTPS_CONFIGURATION_DUN_DISPATCH_THREAD_STACK_SIZE                131072
#define BTPS_CONFIGURATION_DUN_NUMBER_DISPATCH_MAILBOX_SLOTS                256
...
#define BTPS_CONFIGURATION_FAX_DISPATCH_THREAD_STACK_SIZE                131072
#define BTPS_CONFIGURATION_FAX_NUMBER_DISPATCH_MAILBOX_SLOTS                256
...
#define BTPS_CONFIGURATION_GAVD_SUPPORT_SDP_LANGUAGE_BASE_ID                  1
...
#define BTPS_CONFIGURATION_GAVD_SUPPORT_DELAY_REPORTING                       1
...
#define BTPS_CONFIGURATION_LAP_DISPATCH_THREAD_STACK_SIZE                131072
#define BTPS_CONFIGURATION_LAP_NUMBER_DISPATCH_MAILBOX_SLOTS                256
...
#define BTPS_CONFIGURATION_PAN_DISPATCH_THREAD_STACK_SIZE                131072
...
#define BTPS_CONFIGURATION_ISPP_SUPPORT_QUEUE_SESSION_PACKET_POINTER          0
   ...
   /* GATT Configuration.                                               */
#define BTPS_CONFIGURATION_GATT_DEFAULT_MAXIMUM_SUPPORTED_MTU_SIZE          ((ATT_PROTOCOL_MTU_MAXIMUM > L2CAP_MAXIMUM_SUPPORTED_STACK_MTU)?L2CAP_MAXIMUM_SUPPORTED_STACK_MTU:ATT_PROTOCOL_MTU_MAXIMUM)
...
#define BTPS_CONFIGURATION_GATT_SUPPORT_PATCHING_CONTEXT                    0
#define BTPS_CONFIGURATION_GATT_SUPPORT_SUSPEND_RESUME                      0

   /* Audio configuration.                                              */
#define BTPS_CONFIGURATION_AUD_MAXIMUM_CONCURRENT_STREAMS                      7
...
#define BTPS_CONFIGURATION_AUD_REMOTE_CONTROL_DEFAULT_FRAGMENTS                32
#define BTPS_CONFIGURATION_AUD_REMOTE_CONTROL_MAXIMUM_FRAGMENTS                4096
...
#define BTPS_CONFIGURATION_AUD_SUPPORT_APTX                                    1

   /* AIOS Configuration.                                               */
#define BTPS_CONFIGURATION_AIOS_MAXIMUM_SUPPORTED_INSTANCES               1
...
#define BTPS_CONFIGURATION_BAS_MAXIMUM_SUPPORTED_INSTANCES                1
   ...
   /* BCS Configuration.                                                */
#define BTPS_CONFIGURATION_BCS_MAXIMUM_SUPPORTED_INSTANCES                1
...
#define BTPS_CONFIGURATION_BLS_SUPPORT_INTERMEDIATE_CUFF_PRESSURE         1
   ...
   /* BMS Configuration.                                                */
#define BTPS_CONFIGURATION_BMS_MAXIMUM_SUPPORTED_INSTANCES                1
#define BTPS_CONFIGURATION_BMS_SUPPORT_RELIABLE_WRITE                     1

   /* CGMS Configuration.                                               */
#define BTPS_CONFIGURATION_CGMS_MAXIMUM_SUPPORTED_INSTANCES               1

   /* CPS Configuration                                                 */
#define BTPS_CONFIGURATION_CPS_MAXIMUM_SUPPORTED_INSTANCES                1
#define BTPS_CONFIGURATION_CPS_SUPPORT_CYCLING_POWER_CONTROL_POINT        1
#define BTPS_CONFIGURATION_CPS_SUPPORT_CYCLING_POWER_VECTOR               1
#define BTPS_CONFIGURATION_CPS_SUPPORT_CYCLING_POWER_MEASUREMENT_BROADCAST 1

   /* CSCS Configuration.                                               */
#define BTPS_CONFIGURATION_CSCS_MAXIMUM_SUPPORTED_INSTANCES               1
#define BTPS_CONFIGURATION_CSCS_SUPPORT_SENSOR_LOCATION                   1
#define BTPS_CONFIGURATION_CSCS_SUPPORT_SC_CONTROL_POINT                  1
...
#define BTPS_CONFIGURATION_DIS_SUPPORT_PNP_ID                             1
   ...
   /* ESS Service Configuration.                                        */
#define BTPS_CONFIGURATION_ESS_MAXIMUM_SUPPORTED_INSTANCES                1
...
#define BTPS_CONFIGURATION_GAPS_SUPPORT_CENTRAL_ADDRESS_RESOLUTION        1
...
#define BTPS_CONFIGURATION_GLS_SUPPORT_MEASUREMENT_CONTEXT                1
   ...
   /* HPS Configuration.                                                */
#define BTPS_CONFIGURATION_HPS_MAXIMUM_SUPPORTED_INSTANCES                1
#define BTPS_CONFIGURATION_HPS_MAXIMUM_SUPPORTED_STRING_LENGTH            512
...
#define BTPS_CONFIGURATION_IAS_MAXIMUM_SUPPORTED_INSTANCES                1
   ...
   /* IPS Configuration.                                                */
#define BTPS_CONFIGURATION_IPS_MAXIMUM_SUPPORTED_INSTANCES                1
#define BTPS_CONFIGURATION_IPS_MAXIMUM_SUPPORTED_STRING_LENGTH            248

   /* IPSP Configuration.                                               */
#define BTPS_CONFIGURATION_IPSP_MAXIMUM_SUPPORTED_IPSS_INSTANCES          1
#define BTPS_CONFIGURATION_IPSP_NODE_DEFAULT_CONNECTION_MODE              (cmAutomaticAccept)

   /* LLS Configuration.                                                */
#define BTPS_CONFIGURATION_LLS_MAXIMUM_SUPPORTED_INSTANCES                1

   /* LNS Configuration                                                 */
#define BTPS_CONFIGURATION_LNS_MAXIMUM_SUPPORTED_INSTANCES                1
#define BTPS_CONFIGURATION_LNS_SUPPORT_POSITION_QUALITY                   1
#define BTPS_CONFIGURATION_LNS_SUPPORT_LN_CONTROL_POINT                   1
#define BTPS_CONFIGURATION_LNS_SUPPORT_NAVIGATION                         1

   /* NDCS Configuration.                                               */
#define BTPS_CONFIGURATION_NDCS_MAXIMUM_SUPPORTED_INSTANCES               1

   /* OTS Configuration.                                                */
#define BTPS_CONFIGURATION_OTS_MAXIMUM_SUPPORTED_INSTANCES                1
#define BTPS_CONFIGURATION_OTS_SUPPORT_BR_EDR                             0
#define BTPS_CONFIGURATION_OTS_DEFAULT_LINK_TIMEOUT                       (L2CAP_LINK_TIMEOUT_DEFAULT_VALUE)
#define BTPS_CONFIGURATION_OTS_MAXIMUM_SUPPORTED_MTU                      (L2CAP_MAXIMUM_SUPPORTED_STACK_MTU)
#define BTPS_CONFIGURATION_OTS_DEFAULT_CHANNEL_PDU_SIZE                   1024
#define BTPS_CONFIGURATION_OTS_DEFAULT_CHANNEL_TX_WINDOW                  10
#define BTPS_CONFIGURATION_OTS_DEFAULT_CHANNEL_MAX_TX_ATTEMPTS            255
#define BTPS_CONFIGURATION_OTS_DEFAULT_CHANNEL_MONITOR_TIMEOUT_MS         2000
#define BTPS_CONFIGURATION_OTS_DEFAULT_CHANNEL_RETRANSMISSION_TIMEOUT_MS  300

   /* PASS Configuration.                                               */
#define BTPS_CONFIGURATION_PASS_MAXIMUM_SUPPORTED_INSTANCES               1

   /* PLXS Configuration.                                               */
#define BTPS_CONFIGURATION_PLXS_MAXIMUM_SUPPORTED_INSTANCES               1

   /* RSCS Configuration.                                               */
#define BTPS_CONFIGURATION_RSCS_MAXIMUM_SUPPORTED_INSTANCES               1
#define BTPS_CONFIGURATION_RSCS_SUPPORT_SENSOR_LOCATION                   1
#define BTPS_CONFIGURATION_RSCS_SUPPORT_SC_CONTROL_POINT                  1
...
#define BTPS_CONFIGURATION_TPS_MAXIMUM_SUPPORTED_INSTANCES                1
   ...
   /* TRDS Configuration.                                               */
#define BTPS_CONFIGURATION_TRDS_MAXIMUM_SUPPORTED_INSTANCES              1

   /* UDS Configuration.                                                */
#define BTPS_CONFIGURATION_UDS_MAXIMUM_SUPPORTED_INSTANCES                1
#define BTPS_CONFIGURATION_UDS_MAXIMUM_SUPPORTED_STRING_LENGTH            248

   /* WSS Configuration.                                                */
#define BTPS_CONFIGURATION_WSS_MAXIMUM_SUPPORTED_INSTANCES                1

   /* Linux specific configuration.                                     */
#ifndef BTPS_CONFIGURATION_SERIAL_PORT_NAME_PREFIX

   #define BTPS_CONFIGURATION_SERIAL_PORT_NAME_PREFIX                   "/dev/ttyS"
