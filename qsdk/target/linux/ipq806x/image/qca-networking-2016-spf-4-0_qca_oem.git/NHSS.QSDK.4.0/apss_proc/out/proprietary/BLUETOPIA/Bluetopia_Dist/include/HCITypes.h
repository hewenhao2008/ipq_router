...
/*   10/07/14  T. Cook        Changes for BT 4.2                              */
/******************************************************************************/
...
typedef enum
{
   ...
   hscOneChannel16BitWBSVoice,
   hscOneChannel16BitVoiceOneChannel16BitWBSVoice,
   hscOneChannelmSBCVoice
...
#define HCI_COMMAND_CODE_LE_SET_DATA_LENGTH_OCF                         0x0022
#define HCI_COMMAND_CODE_LE_READ_SUGGESTED_DEFAULT_DATA_LENGTH_OCF      0x0023
#define HCI_COMMAND_CODE_LE_WRITE_SUGGESTED_DEFAULT_DATA_LENGTH_OCF     0x0024
#define HCI_COMMAND_CODE_LE_READ_LOCAL_P256_PUBLIC_KEY_OCF              0x0025
#define HCI_COMMAND_CODE_LE_GENERATE_DHKEY_OCF                          0x0026
#define HCI_COMMAND_CODE_LE_ADD_DEVICE_TO_RESOLVING_LIST_OCF            0x0027
#define HCI_COMMAND_CODE_LE_REMOVE_DEVICE_FROM_RESOLVING_LIST_OCF       0x0028
#define HCI_COMMAND_CODE_LE_CLEAR_RESOLVING_LIST_OCF                    0x0029
#define HCI_COMMAND_CODE_LE_READ_RESOLVING_LIST_SIZE_OCF                0x002A
#define HCI_COMMAND_CODE_LE_READ_PEER_RESOLVABLE_ADDRESS_OCF            0x002B
#define HCI_COMMAND_CODE_LE_READ_LOCAL_RESOLVABLE_ADDRESS_OCF           0x002C
#define HCI_COMMAND_CODE_LE_SET_ADDRESS_RESOLUTION_ENABLE_OCF           0x002D
#define HCI_COMMAND_CODE_LE_SET_RESOLVABLE_PRIVATE_ADDRESS_TIMEOUT_OCF  0x002E
#define HCI_COMMAND_CODE_LE_READ_MAXIMUM_DATA_LENGTH_OCF                0x002F
...
#define HCI_COMMAND_OPCODE_LE_SET_DATA_LENGTH                           (HCI_MAKE_COMMAND_OPCODE(HCI_COMMAND_CODE_LE_CONTROLLER_COMMANDS_OGF, HCI_COMMAND_CODE_LE_SET_DATA_LENGTH_OCF))
#define HCI_COMMAND_OPCODE_LE_READ_SUGGESTED_DEFAULT_DATA_LENGTH        (HCI_MAKE_COMMAND_OPCODE(HCI_COMMAND_CODE_LE_CONTROLLER_COMMANDS_OGF, HCI_COMMAND_CODE_LE_READ_SUGGESTED_DEFAULT_DATA_LENGTH_OCF))
#define HCI_COMMAND_OPCODE_LE_WRITE_SUGGESTED_DEFAULT_DATA_LENGTH       (HCI_MAKE_COMMAND_OPCODE(HCI_COMMAND_CODE_LE_CONTROLLER_COMMANDS_OGF, HCI_COMMAND_CODE_LE_WRITE_SUGGESTED_DEFAULT_DATA_LENGTH_OCF))
#define HCI_COMMAND_OPCODE_LE_READ_LOCAL_P256_PUBLIC_KEY                (HCI_MAKE_COMMAND_OPCODE(HCI_COMMAND_CODE_LE_CONTROLLER_COMMANDS_OGF, HCI_COMMAND_CODE_LE_READ_LOCAL_P256_PUBLIC_KEY_OCF))
#define HCI_COMMAND_OPCODE_LE_GENERATE_DHKEY                            (HCI_MAKE_COMMAND_OPCODE(HCI_COMMAND_CODE_LE_CONTROLLER_COMMANDS_OGF, HCI_COMMAND_CODE_LE_GENERATE_DHKEY_OCF))
#define HCI_COMMAND_OPCODE_LE_ADD_DEVICE_TO_RESOLVING_LIST              (HCI_MAKE_COMMAND_OPCODE(HCI_COMMAND_CODE_LE_CONTROLLER_COMMANDS_OGF, HCI_COMMAND_CODE_LE_ADD_DEVICE_TO_RESOLVING_LIST_OCF))
#define HCI_COMMAND_OPCODE_LE_REMOVE_DEVICE_FROM_RESOLVING_LIST         (HCI_MAKE_COMMAND_OPCODE(HCI_COMMAND_CODE_LE_CONTROLLER_COMMANDS_OGF, HCI_COMMAND_CODE_LE_REMOVE_DEVICE_FROM_RESOLVING_LIST_OCF))
#define HCI_COMMAND_OPCODE_LE_CLEAR_RESOLVING_LIST                      (HCI_MAKE_COMMAND_OPCODE(HCI_COMMAND_CODE_LE_CONTROLLER_COMMANDS_OGF, HCI_COMMAND_CODE_LE_CLEAR_RESOLVING_LIST_OCF))
#define HCI_COMMAND_OPCODE_LE_READ_RESOLVING_LIST_SIZE                  (HCI_MAKE_COMMAND_OPCODE(HCI_COMMAND_CODE_LE_CONTROLLER_COMMANDS_OGF, HCI_COMMAND_CODE_LE_READ_RESOLVING_LIST_SIZE_OCF))
#define HCI_COMMAND_OPCODE_LE_READ_PEER_RESOLVABLE_ADDRESS              (HCI_MAKE_COMMAND_OPCODE(HCI_COMMAND_CODE_LE_CONTROLLER_COMMANDS_OGF, HCI_COMMAND_CODE_LE_READ_PEER_RESOLVABLE_ADDRESS_OCF))
#define HCI_COMMAND_OPCODE_LE_READ_LOCAL_RESOLVABLE_ADDRESS             (HCI_MAKE_COMMAND_OPCODE(HCI_COMMAND_CODE_LE_CONTROLLER_COMMANDS_OGF, HCI_COMMAND_CODE_LE_READ_LOCAL_RESOLVABLE_ADDRESS_OCF))
#define HCI_COMMAND_OPCODE_LE_SET_ADDRESS_RESOLUTION_ENABLE             (HCI_MAKE_COMMAND_OPCODE(HCI_COMMAND_CODE_LE_CONTROLLER_COMMANDS_OGF, HCI_COMMAND_CODE_LE_SET_ADDRESS_RESOLUTION_ENABLE_OCF))
#define HCI_COMMAND_OPCODE_LE_SET_RESOLVABLE_PRIVATE_ADDRESS_TIMEOUT    (HCI_MAKE_COMMAND_OPCODE(HCI_COMMAND_CODE_LE_CONTROLLER_COMMANDS_OGF, HCI_COMMAND_CODE_LE_SET_RESOLVABLE_PRIVATE_ADDRESS_TIMEOUT_OCF))
#define HCI_COMMAND_OPCODE_LE_READ_MAXIMUM_DATA_LENGTH                  (HCI_MAKE_COMMAND_OPCODE(HCI_COMMAND_CODE_LE_CONTROLLER_COMMANDS_OGF, HCI_COMMAND_CODE_LE_READ_MAXIMUM_DATA_LENGTH_OCF))
...
#define HCI_SUBEVENT_CODE_LE_REMOTE_CONNECTION_PARAMETER_REQUEST        0x06
   ...
   /*          contains a Sub Event Code that actually specifies the    */
   /*          Bluetooth Low Energy (LE) event code.                    */
#define HCI_SUBEVENT_CODE_LE_DATA_LENGTH_CHANGE                         0x07
#define HCI_SUBEVENT_CODE_LE_READ_LOCAL_P256_PUBLIC_KEY_COMPLETE        0x08
#define HCI_SUBEVENT_CODE_LE_GENERATE_DHKEY_COMPLETE                    0x09
#define HCI_SUBEVENT_CODE_LE_ENHANCED_CONNECTION_COMPLETE               0x0A
#define HCI_SUBEVENT_CODE_LE_DIRECT_ADVERTISING_REPORT                  0x0B
...
typedef __PACKED_STRUCT_BEGIN__ struct _tagHCI_LE_Set_Data_Length_Command_t
{
   HCI_Command_Header_t HCI_Command_Header;
   NonAlignedWord_t     Connection_Handle;
   NonAlignedWord_t     TxOctets;
   NonAlignedWord_t     TxTime;
} __PACKED_STRUCT_END__ HCI_LE_Set_Data_Length_Command_t;

#define HCI_LE_SET_DATA_LENGTH_COMMAND_SIZE                     (sizeof(HCI_LE_Set_Data_Length_Command_t))

typedef __PACKED_STRUCT_BEGIN__ struct _tagHCI_LE_Read_Suggested_Default_Data_Length_Command_t
{
   HCI_Command_Header_t HCI_Command_Header;
} __PACKED_STRUCT_END__ HCI_LE_Read_Suggested_Default_Data_Length_Command_t;

#define HCI_LE_READ_SUGGESTED_DEFAULT_DATA_LENGTH_COMMAND_SIZE  (sizeof(HCI_LE_Read_Suggested_Default_Data_Length_Command_t))

typedef __PACKED_STRUCT_BEGIN__ struct _tagHCI_LE_Write_Suggested_Default_Data_Length_Command_t
{
   HCI_Command_Header_t HCI_Command_Header;
   NonAlignedWord_t     SuggestedMaxTxOctets;
   NonAlignedWord_t     SuggestedMaxTxTime;
} __PACKED_STRUCT_END__ HCI_LE_Write_Suggested_Default_Data_Length_Command_t;

#define HCI_LE_WRITE_SUGGESTED_DEFAULT_DATA_LENGTH_COMMAND_SIZE (sizeof(HCI_LE_Write_Suggested_Default_Data_Length_Command_t))

typedef __PACKED_STRUCT_BEGIN__ struct _tagHCI_LE_Read_Local_P256_Public_Key_Command_t
{
   HCI_Command_Header_t HCI_Command_Header;
} __PACKED_STRUCT_END__ HCI_LE_Read_Local_P256_Public_Key_Command_t;

#define HCI_LE_READ_LOCAL_P256_PUBLIC_KEY_COMMAND_SIZE          (sizeof(HCI_LE_Read_Local_P256_Public_Key_Command_t))

typedef __PACKED_STRUCT_BEGIN__ struct _tagHCI_LE_Generate_DHKey_Command_t
{
   HCI_Command_Header_t HCI_Command_Header;
   P256_Public_Key_t    Remote_P256_Public_Key;
} __PACKED_STRUCT_END__ HCI_LE_Generate_DHKey_Command_t;

#define HCI_LE_GENERATE_DHKEY_COMMAND_SIZE                      (sizeof(HCI_LE_Generate_DHKey_Command_t))

typedef __PACKED_STRUCT_BEGIN__ struct _tagHCI_LE_Add_Device_To_Resolving_List_Command_t
{
   HCI_Command_Header_t HCI_Command_Header;
   Byte_t               Peer_Identity_Address_Type;
   BD_ADDR_t            Peer_Identity_Address;
   Encryption_Key_t     Peer_IRK;
   Encryption_Key_t     Local_IRK;
} __PACKED_STRUCT_END__ HCI_LE_Add_Device_To_Resolving_List_Command_t;

#define HCI_LE_ADD_DEVICE_TO_RESOLVING_LIST_COMMAND_SIZE        (sizeof(HCI_LE_Add_Device_To_Resolving_List_Command_t))

typedef __PACKED_STRUCT_BEGIN__ struct _tagHCI_LE_Remove_Device_From_Resolving_List_Command_t
{
   HCI_Command_Header_t HCI_Command_Header;
   Byte_t               Peer_Identity_Address_Type;
   BD_ADDR_t            Peer_Identity_Address;
} __PACKED_STRUCT_END__ HCI_LE_Remove_Device_From_Resolving_List_Command_t;

#define HCI_LE_REMOVE_DEVICE_FROM_RESOLVING_LIST_COMMAND_SIZE   (sizeof(HCI_LE_Remove_Device_From_Resolving_List_Command_t))

typedef __PACKED_STRUCT_BEGIN__ struct _tagHCI_LE_Clear_Resolving_List_Command_t
{
   HCI_Command_Header_t HCI_Command_Header;
} __PACKED_STRUCT_END__ HCI_LE_Clear_Resolving_List_Command_t;

#define HCI_LE_CLEAR_RESOLVING_LIST_COMMAND_SIZE                (sizeof(HCI_LE_Clear_Resolving_List_Command_t))

typedef __PACKED_STRUCT_BEGIN__ struct _tagHCI_LE_Read_Resolving_List_Size_Command_t
{
   HCI_Command_Header_t HCI_Command_Header;
} __PACKED_STRUCT_END__ HCI_LE_Read_Resolving_List_Size_Command_t;

#define HCI_LE_READ_RESOLVING_LIST_SIZE_COMMAND_SIZE            (sizeof(HCI_LE_Read_Resolving_List_Size_Command_t))

typedef __PACKED_STRUCT_BEGIN__ struct _tagHCI_LE_Read_Peer_Resolvable_Address_Command_t
{
   HCI_Command_Header_t HCI_Command_Header;
   Byte_t               Peer_Identity_Address_Type;
   BD_ADDR_t            Peer_Identity_Address;
} __PACKED_STRUCT_END__ HCI_LE_Read_Peer_Resolvable_Address_Command_t;

#define HCI_LE_READ_PEER_RESOLVABLE_ADDRESS_COMMAND_SIZE        (sizeof(HCI_LE_Read_Peer_Resolvable_Address_Command_t))

typedef __PACKED_STRUCT_BEGIN__ struct _tagHCI_LE_Read_Local_Resolvable_Address_Command_t
{
   HCI_Command_Header_t HCI_Command_Header;
   Byte_t               Peer_Identity_Address_Type;
   BD_ADDR_t            Peer_Identity_Address;
} __PACKED_STRUCT_END__ HCI_LE_Read_Local_Resolvable_Address_Command_t;

#define HCI_LE_READ_LOCAL_RESOLVABLE_ADDRESS_COMMAND_SIZE       (sizeof(HCI_LE_Read_Local_Resolvable_Address_Command_t))

typedef __PACKED_STRUCT_BEGIN__ struct _tagHCI_LE_Set_Address_Resolution_Enable_Command_t
{
   HCI_Command_Header_t HCI_Command_Header;
   Byte_t               Address_Resolution_Enable;
} __PACKED_STRUCT_END__ HCI_LE_Set_Address_Resolution_Enable_Command_t;

#define HCI_LE_SET_ADDRESS_RESOLUTION_ENABLE_COMMAND_SIZE       (sizeof(HCI_LE_Set_Address_Resolution_Enable_Command_t))

typedef __PACKED_STRUCT_BEGIN__ struct _tagHCI_LE_Set_Resolvable_Private_Address_Timeout_Command_t
{
   HCI_Command_Header_t HCI_Command_Header;
   NonAlignedWord_t     RPA_Timeout;
} __PACKED_STRUCT_END__ HCI_LE_Set_Resolvable_Private_Address_Timeout_Command_t;

#define HCI_LE_SET_RESOLVABLE_PRIVATE_ADDRESS_TIMEOUT_COMMAND_SIZE (sizeof(HCI_LE_Set_Resolvable_Private_Address_Timeout_Command_t))

typedef __PACKED_STRUCT_BEGIN__ struct _tagHCI_LE_Read_Maximum_Data_Length_Command_t
{
   HCI_Command_Header_t HCI_Command_Header;
} __PACKED_STRUCT_END__ HCI_LE_Read_Maximum_Data_Length_Command_t;

#define HCI_LE_READ_MAXIMUM_DATA_LENGTH_COMMAND_SIZE            (sizeof(HCI_LE_Read_Maximum_Data_Length_Command_t))
...
typedef __PACKED_STRUCT_BEGIN__ struct _tagHCI_LE_Data_Length_Change_Event_t
{
   HCI_LE_Meta_Event_Header_t HCI_LE_Meta_Event_Header;
   NonAlignedWord_t           Connection_Handle;
   NonAlignedWord_t           MaxTxOctets;
   NonAlignedWord_t           MaxTxTime;
   NonAlignedWord_t           MaxRxOctets;
   NonAlignedWord_t           MaxRxTime;
} __PACKED_STRUCT_END__ HCI_LE_Data_Length_Change_Event_t;

#define HCI_LE_DATA_LENGTH_CHANGE_EVENT_SIZE                   (sizeof(HCI_LE_Data_Length_Change_Event_t))

typedef __PACKED_STRUCT_BEGIN__ struct _tagHCI_LE_Read_Local_P256_Public_Key_Complete_Event_t
{
   HCI_LE_Meta_Event_Header_t HCI_LE_Meta_Event_Header;
   NonAlignedByte_t           Status;
   P256_Public_Key_t          P256_Public_Key;
} __PACKED_STRUCT_END__ HCI_LE_Read_Local_P256_Public_Key_Complete_Event_t;

#define HCI_LE_READ_LOCAL_P256_PUBLIC_KEY_COMPLETE_EVENT_SIZE  (sizeof(HCI_LE_Read_Local_P256_Public_Key_Complete_Event_t))

typedef __PACKED_STRUCT_BEGIN__ struct _tagHCI_LE_Generate_DHKey_Complete_Event_t
{
   HCI_LE_Meta_Event_Header_t HCI_LE_Meta_Event_Header;
   NonAlignedByte_t           Status;
   Diffie_Hellman_Key_t       DHKey;
} __PACKED_STRUCT_END__ HCI_LE_Generate_DHKey_Complete_Event_t;

#define HCI_LE_GENERATE_DHKEY_COMPLETE_EVENT_SIZE               (sizeof(HCI_LE_Generate_DHKey_Complete_Event_t))

typedef __PACKED_STRUCT_BEGIN__ struct _tagHCI_LE_Enhanced_Connection_Complete_Event_t
{
   HCI_LE_Meta_Event_Header_t HCI_LE_Meta_Event_Header;
   Byte_t                     Status;
   NonAlignedWord_t           Connection_Handle;
   ...
   NonAlignedWord_t           Supervision_Timeout;
   Byte_t                     Master_Clock_Accuracy;
} __PACKED_STRUCT_END__ HCI_LE_Enhanced_Connection_Complete_Event_t;

#define HCI_LE_ENHANCED_CONNECTION_COMPLETE_EVENT_SIZE            (sizeof(HCI_LE_Enhanced_Connection_Complete_Event_t))

   /* The following structure is used with the                          */
   /* HCI_LE_Direct_Advertising_Report_Event_t event to define an       */
   /* individual report entry.                                          */
typedef __PACKED_STRUCT_BEGIN__ struct _tagHCI_LE_Direct_Advertising_Report_Entry_t
{
   Byte_t    Event_Type;
   Byte_t    Address_Type;
   BD_ADDR_t Address;
   Byte_t    Direct_Address_Type;
   BD_ADDR_t Direct_Address;
   SByte_t   RSSI;
} __PACKED_STRUCT_END__ HCI_LE_Direct_Advertising_Report_Entry_t;

#define HCI_LE_DIRECT_ADVERTISING_REPORT_ENTRY_SIZE             (sizeof(HCI_LE_Direct_Advertising_Report_Entry_t))

   /* Direct_Advertising Report Event.  Note that the                   */
   /* Report_Entries member contains zero (or more                      */
   /* HCI_LE_Direct_Advertising_Report_Entry_t's).                      */
typedef __PACKED_STRUCT_BEGIN__ struct _tagHCI_LE_Direct_Advertising_Report_Event_t
{
   HCI_LE_Meta_Event_Header_t               HCI_LE_Meta_Event_Header;
   Byte_t                                   Num_Reports;
   HCI_LE_Direct_Advertising_Report_Entry_t Report_Entries[1];
} __PACKED_STRUCT_END__ HCI_LE_Direct_Advertising_Report_Event_t;
...
#define HCI_LE_DIRECT_ADVERTISING_REPORT_EVENT_SIZE(_x)         ((sizeof(HCI_LE_Direct_Advertising_Report_Event_t) - HCI_LE_DIRECT_ADVERTISING_REPORT_ENTRY_SIZE) + (((unsigned int)(_x))*HCI_LE_DIRECT_ADVERTISING_REPORT_ENTRY_SIZE))
...
typedef __PACKED_STRUCT_BEGIN__ struct _tagHCI_LE_Set_Data_Length_Command_Complete_t
{
   HCI_Command_Complete_Event_Header_t HCI_Event_Header;
   Byte_t                              Status;
   NonAlignedWord_t                    Connection_Handle;
} __PACKED_STRUCT_END__ HCI_LE_Set_Data_Length_Command_Complete_t;

#define HCI_LE_SET_DATA_LENGTH_COMMAND_COMPLETE_EVENT_SIZE      (sizeof(HCI_LE_Set_Data_Length_Command_Complete_t))

typedef __PACKED_STRUCT_BEGIN__ struct _tagHCI_LE_Read_Suggested_Default_Data_Length_Command_Complete_t
{
   HCI_Command_Complete_Event_Header_t HCI_Event_Header;
   Byte_t                              Status;
   NonAlignedWord_t                    SuggestedMaxTxOctets;
   NonAlignedWord_t                    SuggestedMaxTxTime;
} __PACKED_STRUCT_END__ HCI_LE_Read_Suggested_Default_Data_Length_Command_Complete_t;

#define HCI_LE_READ_SUGGESTED_DEFAULT_DATA_LENGTH_COMMAND_COMPLETE_EVENT_SIZE    (sizeof(HCI_LE_Read_Suggested_Default_Data_Length_Command_Complete_t))

typedef __PACKED_STRUCT_BEGIN__ struct _tagHCI_LE_Write_Suggested_Default_Data_Length_Command_Complete_t
{
   HCI_Command_Complete_Event_Header_t HCI_Event_Header;
   Byte_t                              Status;
} __PACKED_STRUCT_END__ HCI_LE_Write_Suggested_Default_Data_Length_Command_Complete_t;

#define HCI_LE_WRITE_SUGGESTED_DEFAULT_DATA_LENGTH_COMMAND_COMPLETE_EVENT_SIZE   (sizeof(HCI_LE_Write_Suggested_Default_Data_Length_Command_Complete_t))

typedef __PACKED_STRUCT_BEGIN__ struct _tagHCI_LE_Add_Device_To_Resolving_List_Command_Complete_t
{
   HCI_Command_Complete_Event_Header_t HCI_Event_Header;
   Byte_t                              Status;
} __PACKED_STRUCT_END__ HCI_LE_Add_Device_To_Resolving_List_Command_Complete_t;

#define HCI_LE_ADD_DEVICE_TO_RESOLVING_LIST_COMMAND_COMPLETE_EVENT_SIZE    (sizeof(HCI_LE_Add_Device_To_Resolving_List_Command_Complete_t))

typedef __PACKED_STRUCT_BEGIN__ struct _tagHCI_LE_Remove_Device_From_Resolving_List_Command_Complete_t
{
   HCI_Command_Complete_Event_Header_t HCI_Event_Header;
   Byte_t                              Status;
} __PACKED_STRUCT_END__ HCI_LE_Remove_Device_From_Resolving_List_Command_Complete_t;

#define HCI_LE_REMOVE_DEVICE_FROM_RESOLVING_LIST_COMMAND_COMPLETE_EVENT_SIZE  (sizeof(HCI_LE_Remove_Device_From_Resolving_List_Command_Complete_t))

typedef __PACKED_STRUCT_BEGIN__ struct _tagHCI_LE_Clear_Resolving_List_Command_Complete_t
{
   HCI_Command_Complete_Event_Header_t HCI_Event_Header;
   Byte_t                              Status;
} __PACKED_STRUCT_END__ HCI_LE_Clear_Resolving_List_Command_Complete_t;

#define HCI_LE_CLEAR_RESOLVING_LIST_COMMAND_COMPLETE_EVENT_SIZE  (sizeof(HCI_LE_Clear_Resolving_List_Command_Complete_t))

typedef __PACKED_STRUCT_BEGIN__ struct _tagHCI_LE_Read_Resolving_List_Size_Command_Complete_t
{
   HCI_Command_Complete_Event_Header_t HCI_Event_Header;
   Byte_t                              Status;
   Byte_t                              Resolving_List_Size;
} __PACKED_STRUCT_END__ HCI_LE_Read_Resolving_List_Size_Command_Complete_t;

#define HCI_LE_READ_RESOLVING_LIST_SIZE_COMMAND_COMPLETE_EVENT_SIZE  (sizeof(HCI_LE_Read_Resolving_List_Size_Command_Complete_t))

typedef __PACKED_STRUCT_BEGIN__ struct _tagHCI_LE_Read_Peer_Resolvable_Address_Command_Complete_t
{
   HCI_Command_Complete_Event_Header_t HCI_Event_Header;
   Byte_t                              Status;
   BD_ADDR_t                           Peer_Resolvable_Address;
} __PACKED_STRUCT_END__ HCI_LE_Read_Peer_Resolvable_Address_Command_Complete_t;

#define HCI_LE_READ_PEER_RESOLVABLE_ADDRESS_COMMAND_COMPLETE_EVENT_SIZE    (sizeof(HCI_LE_Read_Peer_Resolvable_Address_Command_Complete_t))

typedef __PACKED_STRUCT_BEGIN__ struct _tagHCI_LE_Read_Local_Resolvable_Address_Command_Complete_t
{
   HCI_Command_Complete_Event_Header_t HCI_Event_Header;
   Byte_t                              Status;
   BD_ADDR_t                           Local_Resolvable_Address;
} __PACKED_STRUCT_END__ HCI_LE_Read_Local_Resolvable_Address_Command_Complete_t;

#define HCI_LE_READ_LOCAL_RESOLVABLE_ADDRESS_COMMAND_COMPLETE_EVENT_SIZE   (sizeof(HCI_LE_Read_Local_Resolvable_Address_Command_Complete_t))

typedef __PACKED_STRUCT_BEGIN__ struct _tagHCI_LE_Set_Address_Resolution_Enable_Command_Complete_t
{
   HCI_Command_Complete_Event_Header_t HCI_Event_Header;
   Byte_t                              Status;
} __PACKED_STRUCT_END__ HCI_LE_Set_Address_Resolution_Enable_Command_Complete_t;

#define HCI_LE_SET_ADDRESS_RESOLUTION_ENABLE_COMMAND_COMPLETE_EVENT_SIZE   (sizeof(HCI_LE_Set_Address_Resolution_Enable_Command_Complete_t))

typedef __PACKED_STRUCT_BEGIN__ struct _tagHCI_LE_Set_Resolvable_Private_Address_Timeout_Command_Complete_t
{
   HCI_Command_Complete_Event_Header_t HCI_Event_Header;
   Byte_t                              Status;
} __PACKED_STRUCT_END__ HCI_LE_Set_Resolvable_Private_Address_Timeout_Command_Complete_t;

#define HCI_LE_SET_RESOLVABLE_PRIVATE_ADDRESS_TIMEOUT_COMMAND_COMPLETE_EVENT_SIZE (sizeof(HCI_LE_Set_Resolvable_Private_Address_Timeout_Command_Complete_t))

typedef __PACKED_STRUCT_BEGIN__ struct _tagHCI_LE_Read_Maximum_Data_Length_Command_Complete_t
{
   HCI_Command_Complete_Event_Header_t HCI_Event_Header;
   Byte_t                              Status;
   NonAlignedWord_t                    SupportedMaxTxOctets;
   NonAlignedWord_t                    SupportedMaxTxTime;
   NonAlignedWord_t                    SupportedMaxRxOctets;
   NonAlignedWord_t                    SupportedMaxRxTime;
} __PACKED_STRUCT_END__ HCI_LE_Read_Maximum_Data_Length_Command_Complete_t;

#define HCI_LE_READ_MAXIMUM_DATA_LENGTH_COMMAND_COMPLETE_EVENT_SIZE        (sizeof(HCI_LE_Read_Maximum_Data_Length_Command_Complete_t))
...
typedef __PACKED_STRUCT_BEGIN__ struct _tagHCI_LE_Read_Local_P256_Public_Key_Command_Status_Event_t
{
   HCI_Command_Status_Event_t HCI_Command_Status_Event;
} __PACKED_STRUCT_END__ HCI_LE_Read_Local_P256_Public_Key_Command_Status_Event_t;

#define HCI_LE_READ_LOCAL_P256_PUBLIC_KEY_COMMAND_STATUS_EVENT_SIZE  (sizeof(HCI_LE_Read_Local_P256_Public_Key_Command_Status_Event_t))

typedef __PACKED_STRUCT_BEGIN__ struct _tagHCI_LE_Generate_DHKey_Command_Status_Event_t
{
   HCI_Command_Status_Event_t HCI_Command_Status_Event;
} __PACKED_STRUCT_END__ HCI_LE_Generate_DHKey_Command_Status_Event_t;

#define HCI_LE_GENERATE_DHKEY_COMMAND_STATUS_EVENT_SIZE         (sizeof(HCI_LE_Generate_DHKey_Command_Status_Event_t))
...
#define HCI_AIR_MODE_FORMAT_LINEAR_PCM                                  0x04
#define HCI_AIR_MODE_FORMAT_MODIFIED_SBC                                0x05
...
#define HCI_SUPPORTED_COMMAND_LE_SET_DATA_LENGTH                                                0x010E
#define HCI_SUPPORTED_COMMAND_LE_READ_SUGGESTED_DEFAULT_DATA_LENGTH                             0x010F
#define HCI_SUPPORTED_COMMAND_LE_WRITE_SUGGESTED_DEFAULT_DATA_LENGTH                            0x0110
#define HCI_SUPPORTED_COMMAND_LE_READ_LOCAL_P256_PUBLIC_KEY                                     0x0120
#define HCI_SUPPORTED_COMMAND_LE_GENERATE_DH_KEY                                                0x0130
#define HCI_SUPPORTED_COMMAND_LE_ADD_DEVICE_TO_RESOLVING_LIST                                   0x0140
#define HCI_SUPPORTED_COMMAND_LE_REMOVE_DEVICE_FROM_RESOLVING_LIST                              0x0150
#define HCI_SUPPORTED_COMMAND_LE_CLEAR_RESOLVING_LIST                                           0x0160
#define HCI_SUPPORTED_COMMAND_LE_READ_RESOLVING_LIST_SIZE                                       0x0170
#define HCI_SUPPORTED_COMMAND_LE_READ_PEER_RESOLVABLE_ADDRESS                                   0x0180
#define HCI_SUPPORTED_COMMAND_LE_READ_LOCAL_RESOLVABLE_ADDRESS                                  0x0190
#define HCI_SUPPORTED_COMMAND_LE_SET_ADDRESS_RESOLUTION_ENABLE                                  0x01A0
#define HCI_SUPPORTED_COMMAND_LE_SET_RESOLVABLE_PRIVATE_ADDRESS_TIMEOUT                         0x01B0
#define HCI_SUPPORTED_COMMAND_LE_READ_MAXIMUM_DATA_LENGTH                                       0x01C0
...
#define HCI_VERSION_SPECIFICATION_5_0                                   0x09
...
#define HCI_LMP_VERSION_BLUETOOTH_5_0                                   0x09
...
#define HCI_LINK_KEY_TYPE_UNAUTHENTICATED_COMBINATION_KEY_P192          0x04
...
#define HCI_LE_EVENT_MASK_REMOTE_CONNECTION_PARAMETER_REQUEST_BIT_NUMBER 0x05
   ...
   /* to specify the correct HCI Bluetooth LE Event in the LE Event Mask*/
   /* (Version 4.2).                                                    */
#define HCI_LE_EVENT_MASK_DATA_LENGTH_CHANGE_BIT_NUMBER                  0x06
#define HCI_LE_EVENT_MASK_READ_LOCAL_P256_PUBLIC_KEY_COMPLETE_BIT_NUMBER 0x07
#define HCI_LE_EVENT_MASK_GENERATE_DHKEY_COMPLETE_BIT_NUMBER             0x08
#define HCI_LE_EVENT_MASK_ENHANCED_CONNECTION_COMPLETE_BIT_NUMBER        0x09
#define HCI_LE_EVENT_MASK_DIRECT_ADVERTISING_REPORT_EVENT_BIT_NUMBER     0x0A
   ...
   /*          specifications.                                          */
#define HCI_ENABLE_ALL_HCI_LE_EVENTS_IN_EVENT_MASK_PRE_4_2(_x)                                  \
{                                                                                               \
   ASSIGN_EVENT_MASK((_x), 0, 0, 0, 0, 0, 0, 0, 0);                                             \
   ...
   /*          specifications.                                          */
#define HCI_DISABLE_ALL_HCI_LE_EVENTS_IN_EVENT_MASK_PRE_4_2(_x)                                    \
{                                                                                                  \
   ASSIGN_EVENT_MASK((_x), 0, 0, 0, 0, 0, 0, 0, 0);                                                \
...
{                                                                                               \
   ...
   SET_EVENT_MASK_BIT((_x), HCI_LE_EVENT_MASK_LONG_TERM_KEY_REQUEST_BIT_NUMBER);                \
   SET_EVENT_MASK_BIT((_x), HCI_LE_EVENT_MASK_REMOTE_CONNECTION_PARAMETER_REQUEST_BIT_NUMBER);  \
   SET_EVENT_MASK_BIT((_x), HCI_LE_EVENT_MASK_DATA_LENGTH_CHANGE_BIT_NUMBER);                   \
   SET_EVENT_MASK_BIT((_x), HCI_LE_EVENT_MASK_READ_LOCAL_P256_PUBLIC_KEY_COMPLETE_BIT_NUMBER);  \
   SET_EVENT_MASK_BIT((_x), HCI_LE_EVENT_MASK_GENERATE_DHKEY_COMPLETE_BIT_NUMBER);              \
   SET_EVENT_MASK_BIT((_x), HCI_LE_EVENT_MASK_ENHANCED_CONNECTION_COMPLETE_BIT_NUMBER);         \
   SET_EVENT_MASK_BIT((_x), HCI_LE_EVENT_MASK_DIRECT_ADVERTISING_REPORT_EVENT_BIT_NUMBER);      \
}
...
{                                                                                                  \
   ...
   RESET_EVENT_MASK_BIT((_x), HCI_LE_EVENT_MASK_LONG_TERM_KEY_REQUEST_BIT_NUMBER);                 \
   RESET_EVENT_MASK_BIT((_x), HCI_LE_EVENT_MASK_REMOTE_CONNECTION_PARAMETER_REQUEST_BIT_NUMBER);   \
   RESET_EVENT_MASK_BIT((_x), HCI_LE_EVENT_MASK_DATA_LENGTH_CHANGE_BIT_NUMBER);                    \
   RESET_EVENT_MASK_BIT((_x), HCI_LE_EVENT_MASK_READ_LOCAL_P256_PUBLIC_KEY_COMPLETE_BIT_NUMBER);   \
   RESET_EVENT_MASK_BIT((_x), HCI_LE_EVENT_MASK_GENERATE_DHKEY_COMPLETE_BIT_NUMBER);               \
   RESET_EVENT_MASK_BIT((_x), HCI_LE_EVENT_MASK_ENHANCED_CONNECTION_COMPLETE_BIT_NUMBER);          \
   RESET_EVENT_MASK_BIT((_x), HCI_LE_EVENT_MASK_DIRECT_ADVERTISING_REPORT_EVENT_BIT_NUMBER);       \
}
...
#define HCI_LE_FEATURE_LE_PING_BIT_NUMBER                                     0x04
   ...
   /* specify the correct HCI Bluetooth LE Feature in the LE Feature    */
   /* Mask (Version 4.2).                                               */
#define HCI_LE_FEATURE_LE_DATA_LENGTH_EXTENSION_BIT_NUMBER                    0x05
#define HCI_LE_FEATURE_LE_LL_PRIVACY_BIT_NUMBER                               0x06
#define HCI_LE_FEATURE_LE_EXTENDED_SCANNER_FILTER_POLICIES_BIT_NUMBER         0x07
...
#define HCI_LE_ADDRESS_TYPE_RANDOM                                      0x01
   ...
   /* The following constants represent the extended address type       */
   /* values that may be passed to LE HCI commands that take a          */
   ...
   /*          events.                                                  */
#define HCI_LE_PEER_ADDRESS_TYPE_PUBLIC                                 0x00
#define HCI_LE_PEER_ADDRESS_TYPE_RANDOM                                 0x01
#define HCI_LE_PEER_ADDRESS_TYPE_PUBLIC_IDENTITY_ADDRESS                0x02
#define HCI_LE_PEER_ADDRESS_TYPE_STATIC_RANDOM_IDENTITY_ADDRESS         0x03
   ...
   /*     HCI_LE_OWN_ADDRESS_TYPE_RPA_CONTROLLER_GENERATED_FALLBACK_XXX */
   ...
   /*          controller.                                              */
#define HCI_LE_OWN_ADDRESS_TYPE_PUBLIC                                   0x00
#define HCI_LE_OWN_ADDRESS_TYPE_RANDOM                                   0x01
#define HCI_LE_OWN_ADDRESS_TYPE_RPA_CONTROLLER_GENERATED_FALLBACK_PUBLIC 0x02
#define HCI_LE_OWN_ADDRESS_TYPE_RPA_CONTROLLER_GENERATED_FALLBACK_RANDOM 0x03
...
#define HCI_LE_SCANNING_FILTER_POLICY_ACCEPT_WHITE_LIST_ONLY            0x01
   ...
   /*          Report Event is not masked then this LE event may be     */
   /*          sent by the controller to the host.                      */
#define HCI_LE_SCANNING_FILTER_POLICY_ACCEPT_UNDIRECTED_DIRECTED_RPA    0x02
#define HCI_LE_SCANNING_FILTER_POLICY_ACCEPT_WHITE_LIST_DIRECTED_RPA    0x03
...
#define HCI_LE_MINIMUM_LINK_LAYER_DATA_CHANNEL_PACKET_PAYLOAD_OCTETS    0x001B
#define HCI_LE_MAXIMUM_LINK_LAYER_DATA_CHANNEL_PACKET_PAYLOAD_OCTETS    0x00FB
...
#define HCI_LE_MINIMUM_LINK_LAYER_DATA_CHANNEL_PACKET_MICROSECONDS      0x0148
#define HCI_LE_MAXIMUM_LINK_LAYER_DATA_CHANNEL_PACKET_MICROSECONDS      0x0848

   /* The following constants represent the minimum and maximum number  */
   /* of seconds that can be set for the resolvable private address     */
   /* (RPA) timeout in the controller.  (Version 4.2).                  */
#define HCI_LE_MINIMUM_RPA_TIMEOUT_SECONDS                              0x0001
#define HCI_LE_MAXIMUM_RPA_TIMEOUT_SECONDS                              0xA1B8
   ...
   /* command (Version 4.2).                                            */
#define HCI_LE_CONTROLLER_ADDRESS_RESOLUTION_DISABLED                   0x00
#define HCI_LE_CONTROLLER_ADDRESS_RESOLUTION_ENABLED                    0x01
