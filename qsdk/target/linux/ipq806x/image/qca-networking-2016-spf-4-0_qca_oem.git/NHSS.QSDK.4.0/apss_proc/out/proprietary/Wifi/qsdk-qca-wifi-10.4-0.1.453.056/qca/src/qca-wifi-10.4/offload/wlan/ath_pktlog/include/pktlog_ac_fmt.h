...
#endif
#define ATH_PKTLOG_TX_STAT_PPDU_ID_MASK 0xffff
#define ATH_PKTLOG_TX_STAT_PPDU_ID_SHIFT 16
#define ATH_PKTLOG_TX_STAT_PPDU_ID_OFFSET 132
...
#define ATH_PKTLOG_TX_STAT_TSF_OFFSET ( ATH_PKTLOG_TX_STAT_PPDU_ID_OFFSET + 68 )
#define ATH_PKTLOG_TX_STAT_RSSI_OFFSET ( ATH_PKTLOG_TX_STAT_TSF_OFFSET + 20 )
#define ATH_PKTLOG_TX_STAT_LSIG_OFFSET ( ATH_PKTLOG_TX_STAT_RSSI_OFFSET + 4 )
