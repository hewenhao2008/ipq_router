...
typedef enum
{
   rcvSuccess            = UDS_USER_CONTROL_POINT_RESPONSE_VALUE_SUCCESS,
   rcvOpCodeNotSupported = UDS_USER_CONTROL_POINT_RESPONSE_VALUE_OP_CODE_NOT_SUPPORTED,
   rcvInvalidParameter   = UDS_USER_CONTROL_POINT_RESPONSE_VALUE_INVALID_PARAMETER,
   rcvOperationFailed    = UDS_USER_CONTROL_POINT_RESPONSE_VALUE_OPERATION_FAILED,
   rcvUserNotAuthorized  = UDS_USER_CONTROL_POINT_RESPONSE_VALUE_USER_NOT_AUTHORIZED
