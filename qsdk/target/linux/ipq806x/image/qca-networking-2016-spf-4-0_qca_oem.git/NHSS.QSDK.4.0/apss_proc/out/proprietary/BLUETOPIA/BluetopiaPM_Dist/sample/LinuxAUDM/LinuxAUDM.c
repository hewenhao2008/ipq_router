...
static int AUDConnectAudio(ParameterList_t *TempParam)
{
   ...
   if(Initialized)
   {
      /* Make sure that all of the parameters required for this function*/
      /* appear to be at least semi-valid.                              */
      if((TempParam) && ((TempParam->NumberofParameters == 2) || ((TempParam->NumberofParameters >= 3) && (TempParam->Params[2].intParam >= 0) && (TempParam->Params[2].intParam <= 3))) && (TempParam->Params[1].intParam >= 0) && (TempParam->Params[1].intParam <= 1) && (TempParam->Params[0].strParam))
      {
         /* Parameters appear to be valid, map the specified parameters */
         /* into the API specific parameters.                           */
...
static int AUDDisconnectAudio(ParameterList_t *TempParam)
{
   ...
   if(Initialized)
   {
      /* Make sure that all of the parameters required for this function*/
      /* appear to be at least semi-valid.                              */
      if((TempParam) && (TempParam->NumberofParameters >= 2) && (TempParam->Params[0].strParam) && (TempParam->Params[1].intParam >= 0) && (TempParam->Params[1].intParam <= 1))
      {
         StrToBD_ADDR(TempParam->Params[0].strParam, &BD_ADDR);
...
static int AUDConnectionRequestResponse(ParameterList_t *TempParam)
{
   ...
   if(Initialized)
   {
      /* Make sure that all of the parameters required for this function*/
      /* appear to be at least semi-valid.                              */
      if((TempParam) && (TempParam->NumberofParameters >= 3) && (TempParam->Params[0].intParam >= 0) && (TempParam->Params[0].intParam <= 1) && (TempParam->Params[1].strParam) && (TempParam->Params[2].intParam >= 0) && (TempParam->Params[2].intParam <= 1))
      {
...
static int AUDSetStreamState(ParameterList_t *TempParam)
{
   ...
   if(Initialized)
   {
      /* Make sure that all of the parameters required for this function*/
      /* appear to be at least semi-valid.                              */
      if((TempParam) && (TempParam->NumberofParameters >= 3) && (TempParam->Params[0].strParam) && (TempParam->Params[1].intParam >= 0) && (TempParam->Params[1].intParam <= 1) && (TempParam->Params[2].intParam >= 0) && (TempParam->Params[2].intParam <= 1))
      {
         StrToBD_ADDR(TempParam->Params[0].strParam, &BD_ADDR);
         StreamType  = ((TempParam->Params[1].intParam == 0)?astSRC:astSNK);
...
static int AUDSetStreamFormat(ParameterList_t *TempParam)
{
   ...
   if(Initialized)
   {
      /* Make sure that all of the parameters required for this function*/
      /* appear to be at least semi-valid.                              */
      if((TempParam) && (TempParam->NumberofParameters >= 4) && (TempParam->Params[0].strParam) && (TempParam->Params[1].intParam >= 0) && (TempParam->Params[1].intParam <= 1))
      {
         /* Note the specified parameters.                              */
         StrToBD_ADDR(TempParam->Params[0].strParam, &BD_ADDR);
...
static int AUDConnectRemoteControl(ParameterList_t *TempParam)
{
   ...
   if(Initialized)
   {
      /* Make sure that all of the parameters required for this function*/
      /* appear to be at least semi-valid.                              */
      if((TempParam) && ((TempParam->NumberofParameters == 1) || ((TempParam->NumberofParameters >= 2) && (TempParam->Params[1].intParam >= 0) && (TempParam->Params[1].intParam <= 3))) && (TempParam->Params[0].strParam))
      {
         /* Parameters appear to be valid, map the specified parameters */
         /* into the API specific parameters.                           */
         StrToBD_ADDR(TempParam->Params[0].strParam, &RemoteDeviceAddress);
